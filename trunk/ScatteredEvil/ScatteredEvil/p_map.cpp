...
boolean PIT_CheckThing(mobj_t *thing)
{
	...
	if(thing->flags&MF_SPECIAL)
	{
		...
		if(tmflags&MF_PICKUP || tmthing->player)
		...
		PTR_ShootTraverse))
	{
		switch(PuffType)
		{
			...
			case MT_FLAMEPUFF:
				...
				break;
			case MT_SERPENTPUFF:
				S_StartSound(t1, SFX_SERPENT_ATTACK);
				break;
			case MT_REIVERPUFF:
				S_StartSound(t1, SFX_WRAITH_ATTACK);
				break;
			case MT_BISHOPPUFF:
				S_StartSound(t1, SFX_BISHOP_ATTACK);
				break;
			default:
				break;
		}
