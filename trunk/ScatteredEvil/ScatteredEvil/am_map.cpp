...
//	glVertex2f(FIX2FLT(CXMTOFX(lines[i].v1->x)), FIX2FLT(CYMTOFX(lines[i].v1->y))/1.2);
//glVertex2f(FIX2FLT(CXMTOFX(lines[i].v2->x)), FIX2FLT(CYMTOFX(lines[i].v2->y))/1.2);
...
//	glDisable(GL_TEXTURE_2D);
	...
	for(i=0; i<numlines; i++)
	{
		...
		gl.Vertex2f(FIX2FLT(CXMTOFX(lines[i].v1->x)), FIX2FLT(CYMTOFX(lines[i].v1->y))/1.2);
