...
void ReadConfig(void)
{
	...
	GetPrivateProfileString("drD3D", "Driver", "", wantedDriver, 40, 
		"./KMod3.ini");
	wantedBits = GetPrivateProfileInt("drD3D", "Color", 16, "./KMod3.ini");
	wantedTexDepth = GetPrivateProfileInt("drD3D", "Texture", 0, "./KMod3.ini");
	wantedZDepth = GetPrivateProfileInt("drD3D", "ZBuffer", 16, "./KMod3.ini");
	showconf = GetPrivateProfileInt("drD3D", "CfgNextTime", 1, "./KMod3.ini");
		...
		|| M_CheckParm("-d3dcfg") /*|| Shift/Ctrl/Alt pressed */)
	{
		...
		WritePrivateProfileString("drD3D", "CfgNextTime", "0", "./KMod3.ini");
		...
		if(ConfigDialog())
		{
			...
			WritePrivateProfileString("drD3D", "Color", buf, "./KMod3.ini");
			sprintf(buf, "%i", wantedTexDepth);
			WritePrivateProfileString("drD3D", "Texture", buf, "./KMod3.ini");
			sprintf(buf, "%i", wantedZDepth);
			WritePrivateProfileString("drD3D", "ZBuffer", buf, "./KMod3.ini");
		}		
	}
	unguard;
}
