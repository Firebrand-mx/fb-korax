#include "h2def.h"
// generated by stateco -- but not any more! -jk
...
"CHA1","CHA2","CHA3","CHA4","CHA5","CHA6","CHA7","CHA8","CHE1","CHE2",
"CHE3","CHE4","CHE5","CHE6","BENC","BUCK","BOOK","STOO","CAUL","TAB1",
"TAB2","OBJ1","OBJ2","OBJ3","OBJ4","OBJ5","OBJ6","OBJ7","OBJ8","OBJ9",
"OB10","OB11","OB12","SHO1",
//Remi
...
"CMAG","CEND",
// CB
"RDMN","RDMA","RDMB","RDMC","RDMD","RDME","RDFX","SCNT","SCSS","STNC",
"ROCY","STPR","DRGD","SORD","SHDW","SHDX","BWND","BSRD","BSEX","CLED",
"MAGD","FHM2","CLHL","FDMD","ICED","SSPD","SSDD","WRTD","LELE","PEAS",
"WOM1","WOM2","WOM3","BLSM","CHLE","ARLE","PRST","SHO2","PLAD","BISD",
"KOD1","ETTF","SSPF","BISF","DRAF","CENF","DM2F","FDMF","ICFL","SORF",
"DEMF","WRAF",
...
void A_CStaffMissileSlither(mobj_t *);
void A_CFlameAttack(player_t *player, pspdef_t *psp);
void A_CFlameRotate(mobj_t *);
void A_CFlamePuff(mobj_t *);
void A_CFlameMissile(mobj_t *);
void A_CHolyAttack(player_t *player, pspdef_t *psp);
void A_CHolyPalette(player_t *player, pspdef_t *psp);
void A_CHolySeek(mobj_t *);
void A_CHolyCheckScream(mobj_t *);
void A_CHolyTail(mobj_t *);
void A_CHolySpawnPuff(mobj_t *);
void A_CHolyAttack2(mobj_t *);
...
void A_LightningZap(mobj_t *);
void A_LightningClip(mobj_t *);
void A_LightningRemove(mobj_t *);
void A_LastZap(mobj_t *);
void A_ZapMimic(mobj_t *);
void A_MStaffAttack(player_t *player, pspdef_t *psp);
void A_MStaffPalette(player_t *player, pspdef_t *psp);
void A_MStaffWeave(mobj_t *);
void A_MStaffTrack(mobj_t *);
void A_SnoutAttack(player_t *player, pspdef_t *psp);
void A_FireConePL1(player_t *player, pspdef_t *psp);
void A_ShedShard(mobj_t *);
...
void A_ProjFire(player_t *player, pspdef_t *psp); //Remi
void A_DontMove(mobj_t *);
void A_MoveAgain(mobj_t *);
void A_PSetReflective(player_t *player, pspdef_t *psp);
void A_PUnSetReflective(player_t *player, pspdef_t *psp);
void A_PossBishWeapCheck(mobj_t *);
...
// CB
void A_Demon3Attack1(mobj_t *);
void A_Demon3Attack2(mobj_t *);
void A_Demon3Death(mobj_t *);
void A_SCentaurAttack(mobj_t *);
void A_SCentaurAttack2(mobj_t *);
void A_SCentaurDropStuff(mobj_t *);
void A_SCentaurDie(mobj_t *);
void A_StoneDeathChunks(mobj_t *);
void A_StoneCheckHeadDone(mobj_t *);
void A_StoneGuyAttack(mobj_t *);
void A_StoneGuyDie(mobj_t *);
void A_StoneGuyMissilePuff(mobj_t *);
void A_StoneGuyMissileExplode(mobj_t *);
...
{SPR_CDLR,0x8000|0,4,NULL,S_ZCHANDELIER2,0,0},	// S_ZCHANDELIER1
{SPR_CDLR,0x8000|1,4,NULL,S_ZCHANDELIER3,0,0},	// S_ZCHANDELIER2
{SPR_CDLR,0x8000|2,4,NULL,S_ZCHANDELIER1,0,0},	// S_ZCHANDELIER3
...
{SPR_TLGL,0x8000,5,A_BridgeOrbit,S_BBALL2,0,0},	// S_BBALL2
...
{SPR_FHMR,4,10,NULL,S_FHAMMERATK_6,5,150},	// S_FHAMMERATK_5
...
{SPR_SPIR,32768 + 0,2,A_CHolySeek,S_HOLY_FX2,0,0},	// S_HOLY_FX1
{SPR_SPIR,32768 + 0,2,A_CHolySeek,S_HOLY_FX3,0,0},	// S_HOLY_FX2
{SPR_SPIR,32768 + 1,2,A_CHolySeek,S_HOLY_FX4,0,0},	// S_HOLY_FX3
{SPR_SPIR,32768 + 1,2,A_CHolyCheckScream,S_HOLY_FX1,0,0},	// S_HOLY_FX4
{SPR_SPIR,32768 + 3,4,NULL,S_HOLY_FX_X2,0,0},	// S_HOLY_FX_X1
{SPR_SPIR,32768 + 4,4,A_Scream,S_HOLY_FX_X3,0,0},	// S_HOLY_FX_X2
{SPR_SPIR,32768 + 5,4,NULL,S_HOLY_FX_X4,0,0},	// S_HOLY_FX_X3
{SPR_SPIR,32768 + 6,4,NULL,S_HOLY_FX_X5,0,0},	// S_HOLY_FX_X4
{SPR_SPIR,32768 + 7,4,NULL,S_HOLY_FX_X6,0,0},	// S_HOLY_FX_X5
{SPR_SPIR,32768 + 8,4,NULL,S_NULL,0,0},	// S_HOLY_FX_X6
...
//Start FDA
{SPR_PIGY,13,5,NULL,S_PIG_FIRE2,0,0},		// S_PIG_FIRE
{SPR_PIGY,14,5,NULL,S_PIG_FIRE3,0,0},		// S_PIG_FIRE2
{SPR_PIGY,15,5,NULL,S_PIG_FIRE4,0,0},		// S_PIG_FIRE3
{SPR_PIGY,16,5,NULL,S_PIG_FIRE5,0,0},		// S_PIG_FIRE4
{SPR_PIGY,17,5,A_NoBlocking,S_PIG_FIRE6,0,0},		// S_PIG_FIRE5
{SPR_PIGY,18,5,NULL,S_NULL,0,0},		// S_PIG_FIRE6
//End FDA
...
// Start damaged states
{SPR_CEND,0,10,A_Look,S_CENTAUR_DAMAGED_LOOK2,0,0},	// S_CENTAUR_DAMAGED_LOOK1
{SPR_CEND,1,10,A_Look,S_CENTAUR_DAMAGED_LOOK1,0,0},	// S_CENTAUR_DAMAGED_LOOK2
{SPR_CEND,0,4,A_Chase,S_CENTAUR_DAMAGED_WALK2,0,0},	// S_CENTAUR_DAMAGED_WALK1
{SPR_CEND,1,4,A_Chase,S_CENTAUR_DAMAGED_WALK3,0,0},	// S_CENTAUR_DAMAGED_WALK2
{SPR_CEND,2,4,A_Chase,S_CENTAUR_DAMAGED_WALK4,0,0},	// S_CENTAUR_DAMAGED_WALK3
{SPR_CEND,3,4,A_Chase,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_WALK4
{SPR_CEND,7,5,A_FaceTarget,S_CENTAUR_DAMAGED_ATK2,0,0},	// S_CENTAUR_DAMAGED_ATK1
{SPR_CEND,8,4,A_FaceTarget,S_CENTAUR_DAMAGED_ATK3,0,0},	// S_CENTAUR_DAMAGED_ATK2
{SPR_CEND,9,7,A_CentaurAttack,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_ATK3
{SPR_CEND,4,10,A_FaceTarget,S_CENTAUR_DAMAGED_MISSILE2,0,0},	// S_CENTAUR_DAMAGED_MISSILE1
{SPR_CEND,5|FF_FULLBRIGHT,8,A_CentaurAttack2,S_CENTAUR_DAMAGED_MISSILE3,0,0},	// S_CENTAUR_DAMAGED_MISSILE2
{SPR_CEND,4,10,A_FaceTarget,S_CENTAUR_DAMAGED_MISSILE4,0,0},	// S_CENTAUR_DAMAGED_MISSILE3
{SPR_CEND,5|FF_FULLBRIGHT,8,A_CentaurAttack2,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_MISSILE4
{SPR_CEND,6,6,A_Pain,S_CENTAUR_DAMAGED_PAIN2,0,0},	// S_CENTAUR_DAMAGED_PAIN1
{SPR_CEND,6,6,A_SetReflective,S_CENTAUR_DAMAGED_PAIN3,0,0},	// S_CENTAUR_DAMAGED_PAIN2
{SPR_CEND,4,15,A_CentaurDefend,S_CENTAUR_DAMAGED_PAIN4,0,0},	// S_CENTAUR_DAMAGED_PAIN3
{SPR_CEND,4,15,A_CentaurDefend,S_CENTAUR_DAMAGED_PAIN5,0,0},	// S_CENTAUR_DAMAGED_PAIN4
{SPR_CEND,4,15,A_CentaurDefend,S_CENTAUR_DAMAGED_PAIN6,0,0},	// S_CENTAUR_DAMAGED_PAIN5
{SPR_CEND,4,1,A_UnSetReflective,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_PAIN6
// End damaged states
...
//Start FDA
{SPR_CENF,0,5,NULL,S_CENTAUR_FIRE2,0,0},		//S_CENTAUR_FIRE
{SPR_CENF,1,5,NULL,S_CENTAUR_FIRE3,0,0},		//S_CENTAUR_FIRE2
{SPR_CENF,2,5,NULL,S_CENTAUR_FIRE4,0,0},		//S_CENTAUR_FIRE3
{SPR_CENF,3,5,NULL,S_CENTAUR_FIRE5,0,0},		//S_CENTAUR_FIRE4
{SPR_CENF,4,5,NULL,S_CENTAUR_FIRE6,0,0},		//S_CENTAUR_FIRE5
{SPR_CENF,5,5,NULL,S_CENTAUR_FIRE7,0,0},		//S_CENTAUR_FIRE6
{SPR_CENF,6,5,NULL,S_CENTAUR_FIRE8,0,0},		//S_CENTAUR_FIRE7
{SPR_CENF,7,5,NULL,S_CENTAUR_FIRE9,0,0},		//S_CENTAUR_FIRE8
{SPR_CENF,8,5,NULL,S_CENTAUR_FIRE10,0,0},		//S_CENTAUR_FIRE9
{SPR_CENF,9,5,NULL,S_CENTAUR_FIRE11,0,0},		//S_CENTAUR_FIRE10
{SPR_CENF,10,5,NULL,S_CENTAUR_FIRE12,0,0},		//S_CENTAUR_FIRE11
{SPR_CENF,11,5,NULL,S_CENTAUR_FIRE13,0,0},		//S_CENTAUR_FIRE12
{SPR_CENF,12,5,NULL,S_CENTAUR_FIRE14,0,0},		//S_CENTAUR_FIRE13
{SPR_CENF,13,5,NULL,S_CENTAUR_FIRE15,0,0},		//S_CENTAUR_FIRE14
{SPR_CENF,14,5,NULL,S_CENTAUR_FIRE16,0,0},		//S_CENTAUR_FIRE15
{SPR_CENF,15,5,A_NoBlocking,S_CENTAUR_FIRE17,0,0},		//S_CENTAUR_FIRE16
{SPR_CENF,16,5,A_QueueCorpse,S_CENTAUR_FIRE18,0,0},		//S_CENTAUR_FIRE17
{SPR_CENF,17,-1,NULL,S_NULL,0,0},		//S_CENTAUR_FIRE18
//End FDA
...
// Start damaged states
{SPR_DEMN,17,10,A_Look,S_DEMN_DAMAGED_LOOK2,0,0},	// S_DEMN_DAMAGED_LOOK1
{SPR_DEMN,17,10,A_Look,S_DEMN_DAMAGED_LOOK1,0,0},	// S_DEMN_DAMAGED_LOOK2
{SPR_DEMN,17,4,A_Chase,S_DEMN_DAMAGED_CHASE2,0,0},	// S_DEMN_DAMAGED_CHASE1
{SPR_DEMN,18,4,A_Chase,S_DEMN_DAMAGED_CHASE3,0,0},	// S_DEMN_DAMAGED_CHASE2
{SPR_DEMN,19,4,A_Chase,S_DEMN_DAMAGED_CHASE4,0,0},	// S_DEMN_DAMAGED_CHASE3
{SPR_DEMN,20,4,A_Chase,S_DEMN_DAMAGED_CHASE1,0,0},	// S_DEMN_DAMAGED_CHASE4
{SPR_DEMN,21,6,A_FaceTarget,S_DEMN_DAMAGED_ATK1_2,0,0},	// S_DEMN_DAMAGED_ATK1_1
{SPR_DEMN,22,8,A_FaceTarget,S_DEMN_DAMAGED_ATK1_3,0,0},	// S_DEMN_DAMAGED_ATK1_2
{SPR_DEMN,23,6,A_DemonAttack1,S_DEMN_DAMAGED_CHASE1,0,0},	// S_DEMN_DAMAGED_ATK1_3
{SPR_DEMN,21,5,A_FaceTarget,S_DEMN_DAMAGED_ATK2_2,0,0},	// S_DEMN_DAMAGED_ATK2_1
{SPR_DEMN,22,6,A_FaceTarget,S_DEMN_DAMAGED_ATK2_3,0,0},	// S_DEMN_DAMAGED_ATK2_2
{SPR_DEMN,23,5,A_DemonAttack2,S_DEMN_DAMAGED_CHASE1,0,0},	// S_DEMN_DAMAGED_ATK2_3
{SPR_DEMN,21,4,NULL,S_DEMN_DAMAGED_PAIN2,0,0},	// S_DEMN_DAMAGED_PAIN1
{SPR_DEMN,21,4,A_Pain,S_DEMN_DAMAGED_CHASE1,0,0},	// S_DEMN_DAMAGED_PAIN2
// End damaged states
...
{SPR_DEMN,24,5,A_FreezeDeath,S_DEMON_ICE2,0,0},	// S_DEMON_ICE
{SPR_DEMN,24,1,A_FreezeDeathChunks,S_DEMON_ICE2,0,0},	// S_DEMON_ICE2
...
// Start FDA
{SPR_DEMF,0,5,NULL,S_DEMON_FIRE2,0,0},		//S_DEMON_FIRE
{SPR_DEMF,1,5,NULL,S_DEMON_FIRE3,0,0},		//S_DEMON_FIRE2
{SPR_DEMF,2,5,NULL,S_DEMON_FIRE4,0,0},		//S_DEMON_FIRE3
{SPR_DEMF,3,5,NULL,S_DEMON_FIRE5,0,0},		//S_DEMON_FIRE4
{SPR_DEMF,4,5,NULL,S_DEMON_FIRE6,0,0},		//S_DEMON_FIRE5
{SPR_DEMF,5,5,NULL,S_DEMON_FIRE7,0,0},		//S_DEMON_FIRE6
{SPR_DEMF,6,5,NULL,S_DEMON_FIRE8,0,0},		//S_DEMON_FIRE7
{SPR_DEMF,7,5,NULL,S_DEMON_FIRE9,0,0},		//S_DEMON_FIRE8
{SPR_DEMF,8,5,NULL,S_DEMON_FIRE10,0,0},		//S_DEMON_FIRE9
{SPR_DEMF,9,5,NULL,S_DEMON_FIRE11,0,0},		//S_DEMON_FIRE10
{SPR_DEMF,10,5,NULL,S_DEMON_FIRE12,0,0},		//S_DEMON_FIRE11
{SPR_DEMF,11,5,NULL,S_DEMON_FIRE13,0,0},		//S_DEMON_FIRE12
{SPR_DEMF,12,5,NULL,S_DEMON_FIRE14,0,0},		//S_DEMON_FIRE13
{SPR_DEMF,13,5,NULL,S_DEMON_FIRE15,0,0},		//S_DEMON_FIRE14
{SPR_DEMF,14,5,NULL,S_DEMON_FIRE16,0,0},		//S_DEMON_FIRE15
{SPR_DEMF,15,5,A_NoBlocking,S_DEMON_FIRE17,0,0},		//S_DEMON_FIRE16
{SPR_DEMF,16,5,A_QueueCorpse,S_DEMON_FIRE18,0,0},		//S_DEMON_FIRE17
{SPR_DEMF,17,-1,NULL,S_NULL,0,0},		//S_DEMON_FIRE18
// End FDA
...
{SPR_DEM2,6,6,A_Demon2Attack1,S_DEMN2_CHASE1,0,0},	// S_DEMN2_ATK1_3
...
// Start damaged states
{SPR_DEM2,16,10,A_Look,S_DEMN2_DAMAGED_LOOK2,0,0},	// S_DEMN2_DAMAGED_LOOK1
{SPR_DEM2,16,10,A_Look,S_DEMN2_DAMAGED_LOOK1,0,0},	// S_DEMN2_DAMAGED_LOOK2
{SPR_DEM2,16,4,A_Chase,S_DEMN2_DAMAGED_CHASE2,0,0},	// S_DEMN2_DAMAGED_CHASE1
{SPR_DEM2,17,4,A_Chase,S_DEMN2_DAMAGED_CHASE3,0,0},	// S_DEMN2_DAMAGED_CHASE2
{SPR_DEM2,18,4,A_Chase,S_DEMN2_DAMAGED_CHASE4,0,0},	// S_DEMN2_DAMAGED_CHASE3
{SPR_DEM2,19,4,A_Chase,S_DEMN2_DAMAGED_CHASE1,0,0},	// S_DEMN2_DAMAGED_CHASE4
{SPR_DEM2,20,6,A_FaceTarget,S_DEMN2_DAMAGED_ATK1_2,0,0},	// S_DEMN2_DAMAGED_ATK1_1
{SPR_DEM2,21,8,A_FaceTarget,S_DEMN2_DAMAGED_ATK1_3,0,0},	// S_DEMN2_DAMAGED_ATK1_2
{SPR_DEM2,22,6,A_Demon2Attack1,S_DEMN2_DAMAGED_CHASE1,0,0},	// S_DEMN2_DAMAGED_ATK1_3
{SPR_DEM2,20,5,A_FaceTarget,S_DEMN2_DAMAGED_ATK2_2,0,0},	// S_DEMN2_DAMAGED_ATK2_1
{SPR_DEM2,21,6,A_FaceTarget,S_DEMN2_DAMAGED_ATK2_3,0,0},	// S_DEMN2_DAMAGED_ATK2_2
{SPR_DEM2,22,5,A_DemonAttack2,S_DEMN2_DAMAGED_CHASE1,0,0},	// S_DEMN2_DAMAGED_ATK2_3
{SPR_DEM2,20,4,NULL,S_DEMN2_DAMAGED_PAIN2,0,0},	// S_DEMN2_DAMAGED_PAIN1
{SPR_DEM2,20,4,A_Pain,S_DEMN2_DAMAGED_CHASE1,0,0},	// S_DEMN2_DAMAGED_PAIN2
// End damaged states
...
{SPR_DEMN,16,5,A_FreezeDeath,S_DEMON_ICE2,0,0},	// S_DEMN2_ICE
{SPR_DEMN,16,1,A_FreezeDeathChunks,S_DEMON_ICE2,0,0},	// S_DEMN2_ICE2
...
//Start FDA
{SPR_DM2F,0,5,NULL,S_DEMON2_FIRE2,0,0},		//S_DEMON_FIRE
{SPR_DM2F,1,5,NULL,S_DEMON2_FIRE3,0,0},		//S_DEMON_FIRE2
{SPR_DM2F,2,5,NULL,S_DEMON2_FIRE4,0,0},		//S_DEMON_FIRE3
{SPR_DM2F,3,5,NULL,S_DEMON2_FIRE5,0,0},		//S_DEMON_FIRE4
{SPR_DM2F,4,5,NULL,S_DEMON2_FIRE6,0,0},		//S_DEMON_FIRE5
{SPR_DM2F,5,5,NULL,S_DEMON2_FIRE7,0,0},		//S_DEMON_FIRE6
{SPR_DM2F,6,5,NULL,S_DEMON2_FIRE8,0,0},		//S_DEMON_FIRE7
{SPR_DM2F,7,5,NULL,S_DEMON2_FIRE9,0,0},		//S_DEMON_FIRE8
{SPR_DM2F,8,5,NULL,S_DEMON2_FIRE10,0,0},		//S_DEMON_FIRE9
{SPR_DM2F,9,5,NULL,S_DEMON2_FIRE11,0,0},		//S_DEMON_FIRE10
{SPR_DM2F,10,5,NULL,S_DEMON2_FIRE12,0,0},		//S_DEMON_FIRE11
{SPR_DM2F,11,5,NULL,S_DEMON2_FIRE13,0,0},		//S_DEMON_FIRE12
{SPR_DM2F,12,5,NULL,S_DEMON2_FIRE14,0,0},		//S_DEMON_FIRE13
{SPR_DM2F,13,5,NULL,S_DEMON2_FIRE15,0,0},		//S_DEMON_FIRE14
{SPR_DM2F,14,5,NULL,S_DEMON2_FIRE16,0,0},		//S_DEMON_FIRE15
{SPR_DM2F,15,5,A_NoBlocking,S_DEMON2_FIRE17,0,0},		//S_DEMON_FIRE16
{SPR_DM2F,16,5,A_QueueCorpse,S_DEMON2_FIRE18,0,0},		//S_DEMON_FIRE17
{SPR_DM2F,17,-1,NULL,S_NULL,0,0},		//S_DEMON_FIRE18
//End FDA
...
// Start Damaged
{SPR_WRTD,0,2,A_WraithRaiseInit,S_DAMAGED_WRAITH_RAISE2,0,0},	// S_DAMAGED_WRAITH_RAISE1
{SPR_WRTD,0,2,A_WraithRaise,S_DAMAGED_WRAITH_RAISE3,0,0},	// S_DAMAGED_WRAITH_RAISE2
{SPR_WRTD,0,2,A_FaceTarget,S_DAMAGED_WRAITH_RAISE4,0,0},	// S_DAMAGED_WRAITH_RAISE3
{SPR_WRTD,1,2,A_WraithRaise,S_DAMAGED_WRAITH_RAISE5,0,0},	// S_DAMAGED_WRAITH_RAISE4
{SPR_WRTD,1,2,A_WraithRaise,S_DAMAGED_WRAITH_RAISE2,0,0},	// S_DAMAGED_WRAITH_RAISE5
{SPR_WRTD,0,10,NULL,S_DAMAGED_WRAITH_INIT2,0,0},	// S_DAMAGED_WRAITH_INIT1
{SPR_WRTD,1,5,A_WraithInit,S_DAMAGED_WRAITH_LOOK1,0,0},	// S_DAMAGED_WRAITH_INIT2
{SPR_WRTD,0,15,A_WraithLook,S_DAMAGED_WRAITH_LOOK2,0,0},	// S_DAMAGED_WRAITH_LOOK1
{SPR_WRTD,1,15,A_WraithLook,S_DAMAGED_WRAITH_LOOK1,0,0},	// S_DAMAGED_WRAITH_LOOK2
{SPR_WRTD,0,4,A_WraithChase,S_DAMAGED_WRAITH_CHASE2,0,0},	// S_DAMAGED_WRAITH_CHASE1
{SPR_WRTD,1,4,A_WraithChase,S_DAMAGED_WRAITH_CHASE3,0,0},	// S_DAMAGED_WRAITH_CHASE2
{SPR_WRTD,2,4,A_WraithChase,S_DAMAGED_WRAITH_CHASE4,0,0},	// S_DAMAGED_WRAITH_CHASE3
{SPR_WRTD,3,4,A_WraithChase,S_DAMAGED_WRAITH_CHASE1,0,0},	// S_DAMAGED_WRAITH_CHASE4
{SPR_WRTD,4,6,A_FaceTarget,S_DAMAGED_WRAITH_ATK1_2,0,0},	// S_DAMAGED_WRAITH_ATK1_1
{SPR_WRTD,5,6,A_WraithFX3,S_DAMAGED_WRAITH_ATK1_3,0,0},	// S_DAMAGED_WRAITH_ATK1_2
{SPR_WRTD,6,6,A_WraithMelee,S_DAMAGED_WRAITH_CHASE1,0,0},	// S_DAMAGED_WRAITH_ATK1_3
{SPR_WRTD,4,6,A_FaceTarget,S_DAMAGED_WRAITH_ATK2_2,0,0},	// S_DAMAGED_WRAITH_ATK2_1
{SPR_WRTD,5,6,NULL,S_DAMAGED_WRAITH_ATK2_3,0,0},	// S_DAMAGED_WRAITH_ATK2_2
{SPR_WRTD,6,6,A_WraithMissile,S_DAMAGED_WRAITH_CHASE1,0,0},	// S_DAMAGED_WRAITH_ATK2_3
{SPR_WRTD,0,2,NULL,S_DAMAGED_WRAITH_PAIN2,0,0},	// S_DAMAGED_WRAITH_PAIN1
{SPR_WRTD,7,6,A_Pain,S_DAMAGED_WRAITH_CHASE1,0,0},	// S_DAMAGED_WRAITH_PAIN2
// End Damaged
...
// Start FDA
{SPR_WRAF,0,5,NULL,S_WRAITH_FIRE2,0,0},		//S_WRAITH_FIRE
{SPR_WRAF,1,5,NULL,S_WRAITH_FIRE3,0,0},		//S_WRAITH_FIRE2
{SPR_WRAF,2,5,NULL,S_WRAITH_FIRE4,0,0},		//S_WRAITH_FIRE3
{SPR_WRAF,3,5,NULL,S_WRAITH_FIRE5,0,0},		//S_WRAITH_FIRE4
{SPR_WRAF,4,5,NULL,S_WRAITH_FIRE6,0,0},		//S_WRAITH_FIRE5
{SPR_WRAF,5,5,NULL,S_WRAITH_FIRE7,0,0},		//S_WRAITH_FIRE6
{SPR_WRAF,6,5,NULL,S_WRAITH_FIRE8,0,0},		//S_WRAITH_FIRE7
{SPR_WRAF,7,5,NULL,S_WRAITH_FIRE9,0,0},		//S_WRAITH_FIRE8
{SPR_WRAF,8,5,NULL,S_WRAITH_FIRE10,0,0},		//S_WRAITH_FIRE9
{SPR_WRAF,9,5,NULL,S_WRAITH_FIRE11,0,0},		//S_WRAITH_FIRE10
{SPR_WRAF,10,5,NULL,S_WRAITH_FIRE12,0,0},		//S_WRAITH_FIRE11
{SPR_WRAF,11,5,NULL,S_WRAITH_FIRE13,0,0},		//S_WRAITH_FIRE12
{SPR_WRAF,12,5,NULL,S_WRAITH_FIRE14,0,0},		//S_WRAITH_FIRE13
{SPR_WRAF,13,5,NULL,S_WRAITH_FIRE15,0,0},		//S_WRAITH_FIRE14
{SPR_WRAF,14,5,NULL,S_WRAITH_FIRE16,0,0},		//S_WRAITH_FIRE15
{SPR_WRAF,15,5,A_NoBlocking,S_WRAITH_FIRE17,0,0},		//S_WRAITH_FIRE16
{SPR_WRAF,16,5,A_QueueCorpse,S_WRAITH_FIRE18,0,0},		//S_WRAITH_FIRE17
{SPR_WRAF,17,-1,NULL,S_NULL,0,0},		//S_WRAITH_FIRE18
//End FDA
...
// Start Damaged
{SPR_SSPD,7,10,A_Look,S_DAMAGED_SERPENT_LOOK1,0,0},	// S_DAMAGED_SERPENT_LOOK1
{SPR_SSPD,7,1,A_SerpentChase,S_DAMAGED_SERPENT_SWIM2,0,0},	// S_DAMAGED_SERPENT_SWIM1
{SPR_SSPD,7,1,A_SerpentChase,S_DAMAGED_SERPENT_SWIM3,0,0},	// S_DAMAGED_SERPENT_SWIM2
{SPR_SSPD,7,2,A_SerpentHumpDecide,S_DAMAGED_SERPENT_SWIM1,0,0},	// S_DAMAGED_SERPENT_SWIM3
{SPR_SSPD,7,3,A_SerpentUnHide,S_DAMAGED_SERPENT_HUMP2,0,0},	// S_DAMAGED_SERPENT_HUMP1
{SPR_SSPD,4,3,A_SerpentRaiseHump,S_DAMAGED_SERPENT_HUMP3,0,0},	// S_DAMAGED_SERPENT_HUMP2
{SPR_SSPD,5,3,A_SerpentRaiseHump,S_DAMAGED_SERPENT_HUMP4,0,0},	// S_DAMAGED_SERPENT_HUMP3
{SPR_SSPD,6,3,A_SerpentRaiseHump,S_DAMAGED_SERPENT_HUMP5,0,0},	// S_DAMAGED_SERPENT_HUMP4
{SPR_SSPD,4,3,A_SerpentRaiseHump,S_DAMAGED_SERPENT_HUMP6,0,0},	// S_DAMAGED_SERPENT_HUMP5
{SPR_SSPD,5,3,A_SerpentRaiseHump,S_DAMAGED_SERPENT_HUMP7,0,0},	// S_DAMAGED_SERPENT_HUMP6
{SPR_SSPD,6,3,NULL,S_DAMAGED_SERPENT_HUMP8,0,0},	// S_DAMAGED_SERPENT_HUMP7
{SPR_SSPD,4,3,NULL,S_DAMAGED_SERPENT_HUMP9,0,0},	// S_DAMAGED_SERPENT_HUMP8
{SPR_SSPD,5,3,NULL,S_DAMAGED_SERPENT_HUMP10,0,0},	// S_DAMAGED_SERPENT_HUMP9
{SPR_SSPD,6,3,A_SerpentLowerHump,S_DAMAGED_SERPENT_HUMP11,0,0},	// S_DAMAGED_SERPENT_HUMP10
{SPR_SSPD,4,3,A_SerpentLowerHump,S_DAMAGED_SERPENT_HUMP12,0,0},	// S_DAMAGED_SERPENT_HUMP11
{SPR_SSPD,5,3,A_SerpentLowerHump,S_DAMAGED_SERPENT_HUMP13,0,0},	// S_DAMAGED_SERPENT_HUMP12
{SPR_SSPD,6,3,A_SerpentLowerHump,S_DAMAGED_SERPENT_HUMP14,0,0},	// S_DAMAGED_SERPENT_HUMP13
{SPR_SSPD,4,3,A_SerpentLowerHump,S_DAMAGED_SERPENT_HUMP15,0,0},	// S_DAMAGED_SERPENT_HUMP14
{SPR_SSPD,5,3,A_SerpentHide,S_DAMAGED_SERPENT_SWIM1,0,0},	// S_DAMAGED_SERPENT_HUMP15
{SPR_SSPD,0,1,A_UnHideThing,S_DAMAGED_SERPENT_SURFACE2,0,0},	// S_DAMAGED_SERPENT_SURFACE1
{SPR_SSPD,0,1,A_SerpentBirthScream,S_DAMAGED_SERPENT_SURFACE3,0,0},	// S_DAMAGED_SERPENT_SURFACE2
{SPR_SSPD,1,3,A_SetShootable,S_DAMAGED_SERPENT_SURFACE4,0,0},	// S_DAMAGED_SERPENT_SURFACE3
{SPR_SSPD,2,3,NULL,S_DAMAGED_SERPENT_SURFACE5,0,0},	// S_DAMAGED_SERPENT_SURFACE4
{SPR_SSPD,3,4,A_SerpentCheckForAttack,S_DAMAGED_SERPENT_DIVE1,0,0},	// S_DAMAGED_SERPENT_SURFACE5
{SPR_SSDD,0,4,NULL,S_DAMAGED_SERPENT_DIVE2,0,0},	// S_DAMAGED_SERPENT_DIVE1
{SPR_SSDD,1,4,NULL,S_DAMAGED_SERPENT_DIVE3,0,0},	// S_DAMAGED_SERPENT_DIVE2
{SPR_SSDD,2,4,NULL,S_DAMAGED_SERPENT_DIVE4,0,0},	// S_DAMAGED_SERPENT_DIVE3
{SPR_SSDD,3,4,A_UnSetShootable,S_DAMAGED_SERPENT_DIVE5,0,0},	// S_DAMAGED_SERPENT_DIVE4
{SPR_SSDD,4,3,A_SerpentDiveSound,S_DAMAGED_SERPENT_DIVE6,0,0},	// S_DAMAGED_SERPENT_DIVE5
{SPR_SSDD,5,3,NULL,S_DAMAGED_SERPENT_DIVE7,0,0},	// S_DAMAGED_SERPENT_DIVE6
{SPR_SSDD,6,4,NULL,S_DAMAGED_SERPENT_DIVE8,0,0},	// S_DAMAGED_SERPENT_DIVE7
{SPR_SSDD,7,4,NULL,S_DAMAGED_SERPENT_DIVE9,0,0},	// S_DAMAGED_SERPENT_DIVE8
{SPR_SSDD,8,3,NULL,S_DAMAGED_SERPENT_DIVE10,0,0},	// S_DAMAGED_SERPENT_DIVE9
{SPR_SSDD,9,3,A_SerpentHide,S_DAMAGED_SERPENT_SWIM1,0,0},	// S_DAMAGED_SERPENT_DIVE10
{SPR_SSPD,8,5,A_SerpentWalk,S_DAMAGED_SERPENT_WALK2,0,0},	// S_DAMAGED_SERPENT_WALK1
{SPR_SSPD,9,5,A_SerpentWalk,S_DAMAGED_SERPENT_WALK3,0,0},	// S_DAMAGED_SERPENT_WALK2
{SPR_SSPD,8,5,A_SerpentWalk,S_DAMAGED_SERPENT_WALK4,0,0},	// S_DAMAGED_SERPENT_WALK3
{SPR_SSPD,9,5,A_SerpentCheckForAttack,S_DAMAGED_SERPENT_DIVE1,0,0},	// S_DAMAGED_SERPENT_WALK4
{SPR_SSPD,11,5,NULL,S_DAMAGED_SERPENT_PAIN2,0,0},	// S_DAMAGED_SERPENT_PAIN1
{SPR_SSPD,11,5,A_Pain,S_DAMAGED_SERPENT_DIVE1,0,0},	// S_DAMAGED_SERPENT_PAIN2
{SPR_SSPD,10,6,A_FaceTarget,S_DAMAGED_SERPENT_ATK2,0,0},	// S_DAMAGED_SERPENT_ATK1
{SPR_SSPD,11,5,A_SerpentChooseAttack,S_DAMAGED_SERPENT_MELEE1,0,0},	// S_DAMAGED_SERPENT_ATK2
{SPR_SSPD,13,5,A_SerpentMeleeAttack,S_DAMAGED_SERPENT_DIVE1,0,0},	// S_DAMAGED_SERPENT_MELEE1
{SPR_SSPD,13,5,A_SerpentMissileAttack,S_DAMAGED_SERPENT_DIVE1,0,0},	// S_DAMAGED_SERPENT_MISSILE1
// End Damaged
...
//Start FDA
{SPR_SSPF,0,5,NULL,S_SERPENT_FIRE2,0,0},		// S_SERPENT_FIRE
{SPR_SSPF,1,5,NULL,S_SERPENT_FIRE3,0,0},		// S_SERPENT_FIRE2
{SPR_SSPF,2,5,NULL,S_SERPENT_FIRE4,0,0},		// S_SERPENT_FIRE3
{SPR_SSPF,3,5,A_NoBlocking,S_SERPENT_FIRE5,0,0},		// S_SERPENT_FIRE4
{SPR_SSPF,4,5,NULL,S_SERPENT_FIRE6,0,0},		// S_SERPENT_FIRE5
{SPR_SSPF,5,5,NULL,S_SERPENT_FIRE7,0,0},		// S_SERPENT_FIRE6
{SPR_SSPF,6,5,NULL,S_SERPENT_FIRE8,0,0},		// S_SERPENT_FIRE7
{SPR_SSPF,7,5,NULL,S_SERPENT_FIRE9,0,0},		// S_SERPENT_FIRE8
{SPR_SSPF,8,5,NULL,S_NULL,0,0},		// S_SERPENT_FIRE9
//End FDA
...
// Start DS
{SPR_BISD,0,10,A_Look,S_DAMAGED_BISHOP_LOOK1,0,0},	// S_DAMAGED_BISHOP_LOOK1
{SPR_BISD,0,1,A_BishopDecide,S_DAMAGED_BISHOP_WALK1,0,0},	// S_DAMAGED_BISHOP_DECIDE
{SPR_BISD,0,2,A_BishopDoBlur,S_DAMAGED_BISHOP_BLUR2,0,0},	// S_DAMAGED_BISHOP_BLUR1
{SPR_BISD,0,4,A_BishopSpawnBlur,S_DAMAGED_BISHOP_BLUR2,0,0},	// S_DAMAGED_BISHOP_BLUR2
{SPR_BISD,0,2,A_Chase,S_DAMAGED_BISHOP_WALK2,0,0},	// S_DAMAGED_BISHOP_WALK1
{SPR_BISD,0,2,A_BishopChase,S_DAMAGED_BISHOP_WALK3,0,0},	// S_DAMAGED_BISHOP_WALK2
{SPR_BISD,0,2,NULL,S_DAMAGED_BISHOP_WALK4,0,0},	// S_DAMAGED_BISHOP_WALK3
{SPR_BISD,1,2,A_BishopChase,S_DAMAGED_BISHOP_WALK5,0,0},	// S_DAMAGED_BISHOP_WALK4
{SPR_BISD,1,2,A_Chase,S_DAMAGED_BISHOP_WALK6,0,0},	// S_DAMAGED_BISHOP_WALK5
{SPR_BISD,1,2,A_BishopChase,S_DAMAGED_BISHOP_DECIDE,0,0},	// S_DAMAGED_BISHOP_WALK6
{SPR_BISD,0,3,A_FaceTarget,S_DAMAGED_BISHOP_ATK2,0,0},	// S_DAMAGED_BISHOP_ATK1
{SPR_BISD,32771,3,A_FaceTarget,S_DAMAGED_BISHOP_ATK3,0,0},	// S_DAMAGED_BISHOP_ATK2
{SPR_BISD,32772,3,A_FaceTarget,S_DAMAGED_BISHOP_ATK4,0,0},	// S_DAMAGED_BISHOP_ATK3
{SPR_BISD,32773,3,A_BishopAttack,S_DAMAGED_BISHOP_ATK5,0,0},	// S_DAMAGED_BISHOP_ATK4
{SPR_BISD,32773,5,A_BishopAttack2,S_DAMAGED_BISHOP_ATK5,0,0},	// S_DAMAGED_BISHOP_ATK5
{SPR_BISD,2,6,A_Pain,S_DAMAGED_BISHOP_PAIN2,0,0},	// S_DAMAGED_BISHOP_PAIN1
{SPR_BISD,2,6,A_BishopPainBlur,S_DAMAGED_BISHOP_PAIN3,0,0},	// S_DAMAGED_BISHOP_PAIN2
{SPR_BISD,2,6,A_BishopPainBlur,S_DAMAGED_BISHOP_PAIN4,0,0},	// S_DAMAGED_BISHOP_PAIN3
{SPR_BISD,2,6,A_BishopPainBlur,S_DAMAGED_BISHOP_PAIN5,0,0},	// S_DAMAGED_BISHOP_PAIN4
{SPR_BISD,2,0,NULL,S_DAMAGED_BISHOP_WALK1,0,0},	// S_DAMAGED_BISHOP_PAIN5
// End DS
...
//Start FDA
{SPR_BISF,0,5,NULL,S_BISHOP_FIRE2,0,0},		//S_BISHOP_FIRE
{SPR_BISF,1,5,NULL,S_BISHOP_FIRE3,0,0},		//S_BISHOP_FIRE2
{SPR_BISF,2,5,NULL,S_BISHOP_FIRE4,0,0},		//S_BISHOP_FIRE3
{SPR_BISF,3,5,NULL,S_BISHOP_FIRE5,0,0},		//S_BISHOP_FIRE4
{SPR_BISF,4,5,NULL,S_BISHOP_FIRE6,0,0},		//S_BISHOP_FIRE5
{SPR_BISF,5,5,NULL,S_BISHOP_FIRE7,0,0},		//S_BISHOP_FIRE6
{SPR_BISF,6,5,NULL,S_BISHOP_FIRE8,0,0},		//S_BISHOP_FIRE7
{SPR_BISF,7,5,NULL,S_BISHOP_FIRE9,0,0},		//S_BISHOP_FIRE8
{SPR_BISF,8,5,NULL,S_BISHOP_FIRE10,0,0},		//S_BISHOP_FIRE9
{SPR_BISF,9,5,NULL,S_BISHOP_FIRE11,0,0},		//S_BISHOP_FIRE10
{SPR_BISF,10,5,NULL,S_BISHOP_FIRE12,0,0},		//S_BISHOP_FIRE11
{SPR_BISF,11,5,NULL,S_BISHOP_FIRE13,0,0},		//S_BISHOP_FIRE12
{SPR_BISF,12,5,NULL,S_BISHOP_FIRE14,0,0},		//S_BISHOP_FIRE13
{SPR_BISF,13,5,NULL,S_BISHOP_FIRE15,0,0},		//S_BISHOP_FIRE14
{SPR_BISF,14,5,NULL,S_BISHOP_FIRE16,0,0},		//S_BISHOP_FIRE15
{SPR_BISF,15,5,A_NoBlocking,S_BISHOP_FIRE17,0,0},		//S_BISHOP_FIRE16
{SPR_BISF,16,5,A_QueueCorpse,S_BISHOP_FIRE18,0,0},		//S_BISHOP_FIRE17
{SPR_BISF,17,-1,NULL,S_NULL,0,0},		//S_BISHOP_FIRE18
//End FDA
...
// Start Damaged
{SPR_DRGD,3,10,A_Look,S_DRAGON_DAMAGED_LOOK1,0,0},	// S_DRAGON_DAMAGED_LOOK1
{SPR_DRGD,2,5,NULL,S_DRAGON_DAMAGED_INIT2,0,0},	// S_DRAGON_DAMAGED_INIT
{SPR_DRGD,1,5,NULL,S_DRAGON_DAMAGED_INIT3,0,0},	// S_DRAGON_DAMAGED_INIT2
{SPR_DRGD,0,5,A_DragonInitFlight,S_DRAGON_DAMAGED_WALK1,0,0},	// S_DRAGON_DAMAGED_INIT3
{SPR_DRGD,1,3,A_DragonFlap,S_DRAGON_DAMAGED_WALK2,0,0},	// S_DRAGON_DAMAGED_WALK1
{SPR_DRGD,1,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK3,0,0},	// S_DRAGON_DAMAGED_WALK2
{SPR_DRGD,2,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK4,0,0},	// S_DRAGON_DAMAGED_WALK3
{SPR_DRGD,2,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK5,0,0},	// S_DRAGON_DAMAGED_WALK4
{SPR_DRGD,3,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK6,0,0},	// S_DRAGON_DAMAGED_WALK5
{SPR_DRGD,3,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK7,0,0},	// S_DRAGON_DAMAGED_WALK6
{SPR_DRGD,2,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK8,0,0},	// S_DRAGON_DAMAGED_WALK7
{SPR_DRGD,2,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK9,0,0},	// S_DRAGON_DAMAGED_WALK8
{SPR_DRGD,1,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK10,0,0},	// S_DRAGON_DAMAGED_WALK9
{SPR_DRGD,1,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK11,0,0},	// S_DRAGON_DAMAGED_WALK10
{SPR_DRGD,0,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK12,0,0},	// S_DRAGON_DAMAGED_WALK11
{SPR_DRGD,0,3,A_DragonFlight,S_DRAGON_DAMAGED_WALK1,0,0},	// S_DRAGON_DAMAGED_WALK12
{SPR_DRGD,4,8,A_DragonAttack,S_DRAGON_DAMAGED_WALK1,0,0},	// S_DRAGON_DAMAGED_ATK1
{SPR_DRGD,5,10,A_DragonPain,S_DRAGON_DAMAGED_WALK1,0,0},	// S_DRAGON_DAMAGED_PAIN1
// Fin Damaged
...
//Start FDA
{SPR_DRAF,0,5,NULL,S_DRAGON_FIRE2,0,0},		//S_DRAGON_FIRE
{SPR_DRAF,1,5,NULL,S_DRAGON_FIRE3,0,0},		//S_DRAGON_FIRE2
{SPR_DRAF,2,5,NULL,S_DRAGON_FIRE4,0,0},		//S_DRAGON_FIRE3
{SPR_DRAF,3,5,NULL,S_DRAGON_FIRE5,0,0},		//S_DRAGON_FIRE4
{SPR_DRAF,4,5,NULL,S_DRAGON_FIRE6,0,0},		//S_DRAGON_FIRE5
{SPR_DRAF,5,5,NULL,S_DRAGON_FIRE7,0,0},		//S_DRAGON_FIRE6
{SPR_DRAF,6,5,NULL,S_DRAGON_FIRE8,0,0},		//S_DRAGON_FIRE7
{SPR_DRAF,7,5,A_NoBlocking,S_DRAGON_FIRE9,0,0},		//S_DRAGON_FIRE8
{SPR_DRAF,8,5,NULL,S_NULL,0,0},		//S_DRAGON_FIRE9
//End FDA
...
//	Start hurt states
{SPR_ETTN,18,10,A_Look,S_ETTIN_HURTED_LOOK2,0,0},	// S_ETTIN_HURTED_LOOK1
{SPR_ETTN,18,10,A_Look,S_ETTIN_HURTED_LOOK1,0,0},	// S_ETTIN_HURTED_LOOK2
{SPR_ETTN,18,5,A_Chase,S_ETTIN_HURTED_CHASE2,0,0},	// S_ETTIN_HURTED_CHASE1
{SPR_ETTN,19,5,A_Chase,S_ETTIN_HURTED_CHASE3,0,0},	// S_ETTIN_HURTED_CHASE2
{SPR_ETTN,20,5,A_Chase,S_ETTIN_HURTED_CHASE4,0,0},	// S_ETTIN_HURTED_CHASE3
{SPR_ETTN,21,5,A_Chase,S_ETTIN_HURTED_CHASE1,0,0},	// S_ETTIN_HURTED_CHASE4
{SPR_ETTN,25,7,A_Pain,S_ETTIN_HURTED_CHASE1,0,0},	// S_ETTIN_HURTED_PAIN1
{SPR_ETTN,22,6,A_FaceTarget,S_ETTIN_HURTED_ATK1_2,0,0},	// S_ETTIN_HURTED_ATK1_1
{SPR_ETTN,23,6,A_FaceTarget,S_ETTIN_HURTED_ATK1_3,0,0},	// S_ETTIN_HURTED_ATK1_2
{SPR_ETTN,24,8,A_EttinAttack,S_ETTIN_HURTED_CHASE1,0,0},	// S_ETTIN_HURTED_ATK1_3
//	End hurt states
...
//Start FDA
{SPR_ETTF,0,5,NULL,S_ETTIN_FIRE2,0,0},	// S_ETTIN_FIRE
{SPR_ETTF,1,5,NULL,S_ETTIN_FIRE3,0,0},		// S_ETTIN_FIRE2
{SPR_ETTF,2,5,NULL,S_ETTIN_FIRE4,0,0},		// S_ETTIN_FIRE3
{SPR_ETTF,3,5,NULL,S_ETTIN_FIRE5,0,0},		// S_ETTIN_FIRE4
{SPR_ETTF,4,5,NULL,S_ETTIN_FIRE6,0,0},		// S_ETTIN_FIRE5
{SPR_ETTF,5,5,NULL,S_ETTIN_FIRE7,0,0},		// S_ETTIN_FIRE6
{SPR_ETTF,6,5,NULL,S_ETTIN_FIRE8,0,0},		// S_ETTIN_FIRE7
{SPR_ETTF,7,5,NULL,S_ETTIN_FIRE9,0,0},		// S_ETTIN_FIRE8
{SPR_ETTF,8,5,NULL,S_ETTIN_FIRE10,0,0},		// S_ETTIN_FIRE9
{SPR_ETTF,9,5,NULL,S_ETTIN_FIRE11,0,0},		// S_ETTIN_FIRE10
{SPR_ETTF,10,5,NULL,S_ETTIN_FIRE12,0,0},		// S_ETTIN_FIRE11
{SPR_ETTF,11,5,NULL,S_ETTIN_FIRE13,0,0},		// S_ETTIN_FIRE12
{SPR_ETTF,12,5,NULL,S_ETTIN_FIRE14,0,0},		// S_ETTIN_FIRE13
{SPR_ETTF,13,5,NULL,S_ETTIN_FIRE15,0,0},		// S_ETTIN_FIRE14
{SPR_ETTF,14,5,NULL,S_ETTIN_FIRE16,0,0},		// S_ETTIN_FIRE15
{SPR_ETTF,15,5,A_NoBlocking,S_ETTIN_FIRE17,0,0},		// S_ETTIN_FIRE16
{SPR_ETTF,16,5,A_QueueCorpse,S_ETTIN_FIRE18,0,0},		// S_ETTIN_FIRE17
{SPR_ETTF,17,-1,NULL,S_NULL,0,0},		// S_ETTIN_FIRE18
//End FDA
...
// Start Damaged
{SPR_FDMN,32791,5,NULL,S_DAMAGED_FIRED_LOOK1,0,0},	// S_DAMAGED_FIRED_SPAWN1
{SPR_FDMD,32772,10,A_Look,S_DAMAGED_FIRED_LOOK2,0,0},	// S_DAMAGED_FIRED_LOOK1
{SPR_FDMD,32773,10,A_Look,S_DAMAGED_FIRED_LOOK3,0,0},	// S_DAMAGED_FIRED_LOOK2
{SPR_FDMD,32774,10,A_Look,S_DAMAGED_FIRED_LOOK1,0,0},	// S_DAMAGED_FIRED_LOOK3
{SPR_FDMD,32772,8,NULL,S_DAMAGED_FIRED_LOOK5,0,0},	// S_DAMAGED_FIRED_LOOK4
{SPR_FDMD,32773,6,NULL,S_DAMAGED_FIRED_LOOK6,0,0},	// S_DAMAGED_FIRED_LOOK5
{SPR_FDMD,32774,5,NULL,S_DAMAGED_FIRED_LOOK7,0,0},	// S_DAMAGED_FIRED_LOOK6
{SPR_FDMD,32773,8,NULL,S_DAMAGED_FIRED_LOOK8,0,0},	// S_DAMAGED_FIRED_LOOK7
{SPR_FDMD,32772,6,NULL,S_DAMAGED_FIRED_LOOK9,0,0},	// S_DAMAGED_FIRED_LOOK8
{SPR_FDMD,32773,7,A_FiredRocks,S_DAMAGED_FIRED_LOOK0,0,0},	// S_DAMAGED_FIRED_LOOK9
{SPR_FDMD,32775,5,NULL,S_DAMAGED_FIRED_LOOKA,0,0},	// S_DAMAGED_FIRED_LOOK0
{SPR_FDMD,32776,5,NULL,S_DAMAGED_FIRED_LOOKB,0,0},	// S_DAMAGED_FIRED_LOOKA
{SPR_FDMD,32777,5,A_UnSetInvulnerable,S_DAMAGED_FIRED_WALK1,0,0},	// S_DAMAGED_FIRED_LOOKB
{SPR_FDMD,32768,5,A_FiredChase,S_DAMAGED_FIRED_WALK2,0,0},	// S_DAMAGED_FIRED_WALK1
{SPR_FDMD,32769,5,A_FiredChase,S_DAMAGED_FIRED_WALK3,0,0},	// S_DAMAGED_FIRED_WALK2
{SPR_FDMD,32770,5,A_FiredChase,S_DAMAGED_FIRED_WALK1,0,0},	// S_DAMAGED_FIRED_WALK3
{SPR_FDMD,32771,6,A_Pain,S_DAMAGED_FIRED_WALK1,0,0},	// S_DAMAGED_FIRED_PAIN1
{SPR_FDMD,32778,3,A_FaceTarget,S_DAMAGED_FIRED_ATTACK2,0,0},	// S_DAMAGED_FIRED_ATTACK1
{SPR_FDMD,32778,5,A_FiredAttack,S_DAMAGED_FIRED_ATTACK3,0,0},	// S_DAMAGED_FIRED_ATTACK2
{SPR_FDMD,32778,5,A_FiredAttack,S_DAMAGED_FIRED_ATTACK4,0,0},	// S_DAMAGED_FIRED_ATTACK3
{SPR_FDMD,32778,5,A_FiredAttack,S_DAMAGED_FIRED_WALK1,0,0},	// S_DAMAGED_FIRED_ATTACK4
// End Damaged
...
//Start FDA
{SPR_FDMF,0,5,NULL,S_FIRED_FIRE2,0,0},		//S_FIRED_FIRE
{SPR_FDMF,1,5,NULL,S_FIRED_FIRE3,0,0},		//S_FIRED_FIRE2
{SPR_FDMF,2,5,NULL,S_FIRED_FIRE4,0,0},		//S_FIRED_FIRE3
{SPR_FDMF,3,5,NULL,S_FIRED_FIRE5,0,0},		//S_FIRED_FIRE4
{SPR_FDMF,4,5,NULL,S_FIRED_FIRE6,0,0},		//S_FIRED_FIRE5
{SPR_FDMF,5,5,NULL,S_FIRED_FIRE7,0,0},		//S_FIRED_FIRE6
{SPR_FDMF,6,5,NULL,S_FIRED_FIRE8,0,0},		//S_FIRED_FIRE7
{SPR_FDMF,7,5,A_NoBlocking,S_FIRED_FIRE9,0,0},		//S_FIRED_FIRE8
{SPR_FDMF,8,5,NULL,S_NULL,0,0},		//S_FIRED_FIRE9
//End FDA
...
// Start Damaged
{SPR_ICED,0,10,A_IceGuyLook,S_DAMAGED_ICEGUY_LOOK,0,0},	// S_DAMAGED_ICEGUY_LOOK
{SPR_ICED,0,-1,NULL,S_DAMAGED_ICEGUY_LOOK,0,0},	// S_DAMAGED_ICEGUY_DORMANT
{SPR_ICED,0,4,A_Chase,S_DAMAGED_ICEGUY_WALK2,0,0},	// S_DAMAGED_ICEGUY_WALK1
{SPR_ICED,1,4,A_IceGuyChase,S_DAMAGED_ICEGUY_WALK3,0,0},	// S_DAMAGED_ICEGUY_WALK2
{SPR_ICED,2,4,A_Chase,S_DAMAGED_ICEGUY_WALK4,0,0},	// S_DAMAGED_ICEGUY_WALK3
{SPR_ICED,3,4,A_Chase,S_DAMAGED_ICEGUY_WALK1,0,0},	// S_DAMAGED_ICEGUY_WALK4
{SPR_ICED,4,3,A_FaceTarget,S_DAMAGED_ICEGUY_ATK2,0,0},	// S_DAMAGED_ICEGUY_ATK1
{SPR_ICED,5,3,A_FaceTarget,S_DAMAGED_ICEGUY_ATK3,0,0},	// S_DAMAGED_ICEGUY_ATK2
{SPR_ICED,32774,8,A_IceGuyAttack,S_DAMAGED_ICEGUY_ATK4,0,0},	// S_DAMAGED_ICEGUY_ATK3
{SPR_ICED,5,4,A_FaceTarget,S_DAMAGED_ICEGUY_WALK1,0,0},	// S_DAMAGED_ICEGUY_ATK4
{SPR_ICED,0,1,A_Pain,S_DAMAGED_ICEGUY_WALK1,0,0},	// S_DAMAGED_ICEGUY_PAIN1
{SPR_ICED,0,1,A_IceGuyDie,S_NULL,0,0},	// S_DAMAGED_ICEGUY_DEATH
// End Damaged
...
//Start FDA
{SPR_ICFL,0,5,NULL,S_ICEGUY_FIRE2,0,0},		//S_ICEGUY_FIRE
{SPR_ICFL,1,5,NULL,S_ICEGUY_FIRE3,0,0},		//S_ICEGUY_FIRE2
{SPR_ICFL,2,5,NULL,S_ICEGUY_FIRE4,0,0},		//S_ICEGUY_FIRE3
{SPR_ICFL,3,5,NULL,S_ICEGUY_FIRE5,0,0},		//S_ICEGUY_FIRE4
{SPR_ICFL,4,5,NULL,S_ICEGUY_FIRE6,0,0},		//S_ICEGUY_FIRE5
{SPR_ICFL,5,5,NULL,S_ICEGUY_FIRE7,0,0},		//S_ICEGUY_FIRE6
{SPR_ICFL,6,5,NULL,S_ICEGUY_FIRE8,0,0},		//S_ICEGUY_FIRE7
{SPR_ICFL,7,5,A_NoBlocking,S_ICEGUY_FIRE9,0,0},		//S_ICEGUY_FIRE8
{SPR_ICFL,8,5,NULL,S_NULL,0,0},		//S_ICEGUY_FIRE9
//End FDA
...
// Start DS
{SPR_PLAD,0,2,NULL,S_DAMAGED_FIGHTER2,0,0},	// S_DAMAGED_FIGHTER
{SPR_PLAD,0,3,A_ClassBossHealth,S_DAMAGED_FIGHTERLOOK,0,0},	// S_DAMAGED_FIGHTER2
{SPR_PLAD,0,5,A_Look,S_DAMAGED_FIGHTERLOOK,0,0},	// S_DAMAGED_FIGHTERLOOK
{SPR_PLAD,0,4,A_FastChase,S_DAMAGED_FIGHTER_RUN2,0,0},	// S_DAMAGED_FIGHTER_RUN1
{SPR_PLAD,1,4,A_FastChase,S_DAMAGED_FIGHTER_RUN3,0,0},	// S_DAMAGED_FIGHTER_RUN2
{SPR_PLAD,2,4,A_FastChase,S_DAMAGED_FIGHTER_RUN4,0,0},	// S_DAMAGED_FIGHTER_RUN3
{SPR_PLAD,3,4,A_FastChase,S_DAMAGED_FIGHTER_RUN1,0,0},	// S_DAMAGED_FIGHTER_RUN4
{SPR_PLAD,4,8,A_FaceTarget,S_DAMAGED_FIGHTER_ATK2,0,0},	// S_DAMAGED_FIGHTER_ATK1
{SPR_PLAD,5,8,A_FighterAttack,S_DAMAGED_FIGHTER_RUN1,0,0},	// S_DAMAGED_FIGHTER_ATK2
{SPR_PLAD,6,4,NULL,S_DAMAGED_FIGHTER_PAIN2,0,0},	// S_DAMAGED_FIGHTER_PAIN
{SPR_PLAD,6,4,A_Pain,S_DAMAGED_FIGHTER_RUN1,0,0},	// S_DAMAGED_FIGHTER_PAIN2
// End DS
...
// Start damage
{SPR_CLED,0,2,NULL,S_DAMAGED_CLERIC2,0,0},	// S_DAMAGED_CLERIC
{SPR_CLED,0,3,A_ClassBossHealth,S_DAMAGED_CLERICLOOK,0,0},	// S_DAMAGED_CLERIC2
{SPR_CLED,0,5,A_Look,S_DAMAGED_CLERICLOOK,0,0},	// S_DAMAGED_CLERICLOOK
{SPR_CLED,0,4,A_FastChase,S_DAMAGED_CLERIC_RUN2,0,0},	// S_DAMAGED_CLERIC_RUN1
{SPR_CLED,1,4,A_FastChase,S_DAMAGED_CLERIC_RUN3,0,0},	// S_DAMAGED_CLERIC_RUN2
{SPR_CLED,2,4,A_FastChase,S_DAMAGED_CLERIC_RUN4,0,0},	// S_DAMAGED_CLERIC_RUN3
{SPR_CLED,3,4,A_FastChase,S_DAMAGED_CLERIC_RUN1,0,0},	// S_DAMAGED_CLERIC_RUN4
{SPR_CLED,4,8,A_FaceTarget,S_DAMAGED_CLERIC_ATK2,0,0},	// S_DAMAGED_CLERIC_ATK1
{SPR_CLED,5,8,A_FaceTarget,S_DAMAGED_CLERIC_ATK3,0,0},	// S_DAMAGED_CLERIC_ATK2
{SPR_CLED,6,10,A_ClericAttack,S_DAMAGED_CLERIC_RUN1,0,0},	// S_DAMAGED_CLERIC_ATK3
{SPR_CLED,7,4,NULL,S_DAMAGED_CLERIC_PAIN2,0,0},	// S_CLERIC_PAIN
{SPR_CLED,7,4,A_Pain,S_DAMAGED_CLERIC_RUN1,0,0},	// S_CLERIC_PAIN2
// End damage
...
// Start Damaged
{SPR_MAGD,0,2,NULL,S_DAMAGED_MAGE2,0,0},	// S_MAGE
{SPR_MAGD,0,3,A_ClassBossHealth,S_DAMAGED_MAGELOOK,0,0},	// S_MAGE2
{SPR_MAGD,0,5,A_Look,S_DAMAGED_MAGELOOK,0,0},	// S_MAGELOOK
{SPR_MAGD,0,4,A_FastChase,S_DAMAGED_MAGE_RUN2,0,0},	// S_MAGE_RUN1
{SPR_MAGD,1,4,A_FastChase,S_DAMAGED_MAGE_RUN3,0,0},	// S_MAGE_RUN2
{SPR_MAGD,2,4,A_FastChase,S_DAMAGED_MAGE_RUN4,0,0},	// S_MAGE_RUN3
{SPR_MAGD,3,4,A_FastChase,S_DAMAGED_MAGE_RUN1,0,0},	// S_MAGE_RUN4
{SPR_MAGD,4,8,A_FaceTarget,S_DAMAGED_MAGE_ATK2,0,0},	// S_MAGE_ATK1
{SPR_MAGD,32773,8,A_MageAttack,S_DAMAGED_MAGE_RUN1,0,0},	// S_MAGE_ATK2
{SPR_MAGD,6,4,NULL,S_DAMAGED_MAGE_PAIN2,0,0},	// S_MAGE_PAIN
{SPR_MAGD,6,4,A_Pain,S_DAMAGED_MAGE_RUN1,0,0},	// S_MAGE_PAIN2
// End Damaged
...
// Damage Start
{SPR_SORD,0,3,NULL,S_SORC_DAMAGED_SPAWN2,0,0},	// S_SORC_DAMAGED_SPAWN1
{SPR_SORD,0,2,A_SorcSpinBalls,S_SORC_DAMAGED_LOOK1,0,0},	// S_SORC_DAMAGED_SPAWN2
{SPR_SORD,0,10,A_Look,S_SORC_DAMAGED_LOOK1,0,0},	// S_SORC_DAMAGED_LOOK1
{SPR_SORD,0,5,A_Chase,S_SORC_DAMAGED_WALK2,0,0},	// S_SORC_DAMAGED_WALK1
{SPR_SORD,1,5,A_Chase,S_SORC_DAMAGED_WALK3,0,0},	// S_SORC_DAMAGED_WALK2
{SPR_SORD,2,5,A_Chase,S_SORC_DAMAGED_WALK4,0,0},	// S_SORC_DAMAGED_WALK3
{SPR_SORD,3,5,A_Chase,S_SORC_DAMAGED_WALK1,0,0},	// S_SORC_DAMAGED_WALK4
{SPR_SORD,6,8,NULL,S_SORC_DAMAGED_PAIN2,0,0},	// S_SORC_DAMAGED_PAIN1
{SPR_SORD,6,8,A_Pain,S_SORC_DAMAGED_WALK1,0,0},	// S_SORC_DAMAGED_PAIN2
{SPR_SORD,4,6,A_FaceTarget,S_SORC_DAMAGED_ATK2_2,0,0},	// S_SORC_DAMAGED_ATK2_1
{SPR_SORD,4,6,A_SpeedBalls,S_SORC_DAMAGED_ATK2_3,0,0},	// S_SORC_DAMAGED_ATK2_2
{SPR_SORD,4,6,A_FaceTarget,S_SORC_DAMAGED_ATK2_3,0,0},	// S_SORC_DAMAGED_ATK2_3
{SPR_SORD,5,6,NULL,S_SORC_DAMAGED_ATTACK2,0,0},	// S_SORC_DAMAGED_ATTACK1
{SPR_SORD,5,6,A_SpawnFizzle,S_SORC_DAMAGED_ATTACK3,0,0},	// S_SORC_DAMAGED_ATTACK2
{SPR_SORD,5,5,A_FaceTarget,S_SORC_DAMAGED_ATTACK2,0,0},	// S_SORC_DAMAGED_ATTACK3
{SPR_SORD,5,2,NULL,S_SORC_DAMAGED_ATTACK5,0,0},	// S_SORC_DAMAGED_ATTACK4
{SPR_SORD,5,2,A_SorcBossAttack,S_SORC_DAMAGED_WALK1,0,0},	// S_SORC_DAMAGED_ATTACK5
// Damage Finish
...
//Start FDA
{SPR_SORF,0,5,NULL,S_SORC_FIRE2,0,0},		// S_SORC_FIRE
{SPR_SORF,1,5,NULL,S_SORC_FIRE3,0,0},		// S_SORC_FIRE2
{SPR_SORF,2,5,NULL,S_SORC_FIRE4,0,0},		// S_SORC_FIRE3
{SPR_SORF,3,5,NULL,S_SORC_FIRE5,0,0},		// S_SORC_FIRE4
{SPR_SORF,4,5,NULL,S_SORC_FIRE6,0,0},		// S_SORC_FIRE5
{SPR_SORF,5,5,NULL,S_SORC_FIRE7,0,0},		// S_SORC_FIRE6
{SPR_SORF,6,5,NULL,S_SORC_FIRE8,0,0},		// S_SORC_FIRE7
{SPR_SORF,7,5,NULL,S_SORC_FIRE9,0,0},		// S_SORC_FIRE8
{SPR_SORF,8,5,NULL,S_SORC_FIRE10,0,0},		// S_SORC_FIRE9
{SPR_SORF,9,5,NULL,S_SORC_FIRE11,0,0},		// S_SORC_FIRE10
{SPR_SORF,10,5,NULL,S_SORC_FIRE12,0,0},		// S_SORC_FIRE11
{SPR_SORF,11,5,NULL,S_SORC_FIRE13,0,0},		// S_SORC_FIRE12
{SPR_SORF,12,5,NULL,S_SORC_FIRE14,0,0},		// S_SORC_FIRE13
{SPR_SORF,13,5,NULL,S_SORC_FIRE15,0,0},		// S_SORC_FIRE14
{SPR_SORF,14,5,NULL,S_SORC_FIRE16,0,0},		// S_SORC_FIRE15
{SPR_SORF,15,5,A_NoBlocking,S_SORC_FIRE17,0,0},		// S_SORC_FIRE16
{SPR_SORF,16,5,A_QueueCorpse,S_SORC_FIRE18,0,0},		// S_SORC_FIRE17
{SPR_SORF,17,-1,NULL,S_NULL,0,0},		// S_SORC_FIRE18
//End FDA
{SPR_RADE,0x8000|0,4,NULL,S_BLASTEFFECT2,0,0},	// S_BLASTEFFECT1
{SPR_RADE,0x8000|1,4,NULL,S_BLASTEFFECT3,0,0},	// S_BLASTEFFECT2
{SPR_RADE,0x8000|2,4,NULL,S_BLASTEFFECT4,0,0},	// S_BLASTEFFECT3
{SPR_RADE,0x8000|3,4,NULL,S_BLASTEFFECT5,0,0},	// S_BLASTEFFECT4
{SPR_RADE,0x8000|4,4,NULL,S_BLASTEFFECT6,0,0},	// S_BLASTEFFECT5
{SPR_RADE,0x8000|5,4,NULL,S_BLASTEFFECT7,0,0},	// S_BLASTEFFECT6
{SPR_RADE,0x8000|6,4,NULL,S_BLASTEFFECT8,0,0},	// S_BLASTEFFECT7
{SPR_RADE,0x8000|7,4,NULL,S_BLASTEFFECT9,0,0},	// S_BLASTEFFECT8
{SPR_RADE,0x8000|8,4,NULL,S_NULL,0,0},	// S_BLASTEFFECT9
...
// Start DS1
{SPR_KOD1,0,5,A_Look,S_DAMAGED1_KORAX_LOOK1,0,0},	// S_DAMAGED1_KORAX_LOOK1
{SPR_KOD1,0,3,A_KoraxStep2,S_DAMAGED1_KORAX_CHASE2,0,0},	// S_DAMAGED1_KORAX_CHASE1
{SPR_KOD1,0,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE3,0,0},	// S_DAMAGED1_KORAX_CHASE2
{SPR_KOD1,0,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE4,0,0},	// S_DAMAGED1_KORAX_CHASE3
{SPR_KOD1,0,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE5,0,0},	// S_DAMAGED1_KORAX_CHASE4
{SPR_KOD1,1,3,A_KoraxStep,S_DAMAGED1_KORAX_CHASE6,0,0},	// S_DAMAGED1_KORAX_CHASE5
{SPR_KOD1,1,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE7,0,0},	// S_DAMAGED1_KORAX_CHASE6
{SPR_KOD1,1,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE8,0,0},	// S_DAMAGED1_KORAX_CHASE7
{SPR_KOD1,1,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE9,0,0},	// S_DAMAGED1_KORAX_CHASE8
{SPR_KOD1,2,3,A_KoraxStep2,S_DAMAGED1_KORAX_CHASE0,0,0},	// S_DAMAGED1_KORAX_CHASE9
{SPR_KOD1,2,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASEA,0,0},	// S_DAMAGED1_KORAX_CHASE0
{SPR_KOD1,2,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASEB,0,0},	// S_DAMAGED1_KORAX_CHASEA
{SPR_KOD1,2,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASEC,0,0},	// S_DAMAGED1_KORAX_CHASEB
{SPR_KOD1,3,3,A_KoraxStep,S_DAMAGED1_KORAX_CHASED,0,0},	// S_DAMAGED1_KORAX_CHASEC
{SPR_KOD1,3,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASEE,0,0},	// S_DAMAGED1_KORAX_CHASED
{SPR_KOD1,3,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASEF,0,0},	// S_DAMAGED1_KORAX_CHASEE
{SPR_KOD1,3,3,A_KoraxChase,S_DAMAGED1_KORAX_CHASE1,0,0},	// S_DAMAGED1_KORAX_CHASEF
{SPR_KOD1,7,5,A_Pain,S_DAMAGED1_KORAX_PAIN2,0,0},	// S_DAMAGED1_KORAX_PAIN1
{SPR_KOD1,7,5,NULL,S_DAMAGED1_KORAX_CHASE2,0,0},	// S_DAMAGED1_KORAX_PAIN2
{SPR_KOD1,32772,2,A_FaceTarget,S_DAMAGED1_KORAX_ATTACK2,0,0},	// S_DAMAGED1_KORAX_ATTACK1
{SPR_KOD1,32772,5,A_KoraxDecide,S_DAMAGED1_KORAX_ATTACK2,0,0},	// S_DAMAGED1_KORAX_ATTACK2
{SPR_KOD1,32772,4,A_FaceTarget,S_DAMAGED1_KORAX_MISSILE2,0,0},	// S_DAMAGED1_KORAX_MISSILE1
{SPR_KOD1,32773,8,A_KoraxMissile,S_DAMAGED1_KORAX_MISSILE3,0,0},	// S_DAMAGED1_KORAX_MISSILE2
{SPR_KOD1,32772,8,NULL,S_DAMAGED1_KORAX_CHASE2,0,0},	// S_DAMAGED1_KORAX_MISSILE3
{SPR_KOD1,32772,5,A_FaceTarget,S_DAMAGED1_KORAX_COMMAND2,0,0},	// S_DAMAGED1_KORAX_COMMAND1
{SPR_KOD1,32790,10,A_FaceTarget,S_DAMAGED1_KORAX_COMMAND3,0,0},	// S_DAMAGED1_KORAX_COMMAND2
{SPR_KOD1,32774,15,A_KoraxCommand,S_DAMAGED1_KORAX_COMMAND4,0,0},	// S_DAMAGED1_KORAX_COMMAND3
{SPR_KOD1,32790,10,NULL,S_DAMAGED1_KORAX_COMMAND5,0,0},	// S_DAMAGED1_KORAX_COMMAND4
{SPR_KOD1,32772,5,NULL,S_DAMAGED1_KORAX_CHASE2,0,0},	// S_DAMAGED1_KORAX_COMMAND5
// End DS1
...
{SPR_MAN1,0,-1,NULL,S_NULL,0,0},	// S_CAMERA

//Added by Korax Project
{SPR_CHA1,0,-1,NULL,S_NULL,0,0}, //S_CHAIR1
{SPR_CHA2,0,-1,NULL,S_NULL,0,0}, //S_CHAIR2
{SPR_CHA3,0,-1,NULL,S_NULL,0,0}, //S_CHAIR3
{SPR_CHA4,0,-1,NULL,S_NULL,0,0}, //S_CHAIR4
{SPR_CHA5,0,-1,NULL,S_NULL,0,0}, //S_CHAIR5
{SPR_CHA6,0,-1,NULL,S_NULL,0,0}, //S_CHAIR6
{SPR_CHA7,0,-1,NULL,S_NULL,0,0}, //S_CHAIR7
{SPR_CHA8,0,-1,NULL,S_NULL,0,0}, //S_CHAIR8
{SPR_CHE1,0,-1,NULL,S_NULL,0,0}, //S_CHEST1
{SPR_CHE2,0,-1,NULL,S_NULL,0,0}, //S_CHEST2
{SPR_CHE3,0,-1,NULL,S_NULL,0,0}, //S_CHEST3
{SPR_CHE4,0,-1,NULL,S_NULL,0,0}, //S_CHEST4
{SPR_CHE5,0,-1,NULL,S_NULL,0,0}, //S_CHEST5
{SPR_CHE6,0,-1,NULL,S_NULL,0,0}, //S_CHEST6
{SPR_BENC,0,-1,NULL,S_NULL,0,0}, //S_BENCH
{SPR_BUCK,0,-1,NULL,S_NULL,0,0}, //S_BUCKET
{SPR_BOOK,0,-1,NULL,S_NULL,0,0}, //S_BOOKCLOSED
{SPR_STOO,0,-1,NULL,S_NULL,0,0}, //S_STOOL
{SPR_CAUL,0,-1,NULL,S_NULL,0,0}, //S_CAULDRON
{SPR_TAB1,0,-1,NULL,S_NULL,0,0}, //S_TABLE1
{SPR_TAB2,0,-1,NULL,S_NULL,0,0}, //S_TABLE2
{SPR_OBJ1,0,-1,NULL,S_NULL,0,0}, //S_OBJECT1
{SPR_OBJ2,0,-1,NULL,S_NULL,0,0}, //S_OBJECT2
{SPR_OBJ3,0,-1,NULL,S_NULL,0,0}, //S_OBJECT3
{SPR_OBJ4,0,-1,NULL,S_NULL,0,0}, //S_OBJECT4
{SPR_OBJ5,0,-1,NULL,S_NULL,0,0}, //S_OBJECT5
{SPR_OBJ6,0,-1,NULL,S_NULL,0,0}, //S_OBJECT6
{SPR_OBJ7,0,-1,NULL,S_NULL,0,0}, //S_OBJECT7
{SPR_OBJ8,0,-1,NULL,S_NULL,0,0}, //S_OBJECT8
{SPR_OBJ9,0,-1,NULL,S_NULL,0,0}, //S_OBJECT9
{SPR_OB10,0,-1,NULL,S_NULL,0,0}, //S_OBJECT10
{SPR_OB11,0,-1,NULL,S_NULL,0,0}, //S_OBJECT11
{SPR_OB12,0,-1,NULL,S_NULL,0,0}, //S_OBJECT12
{SPR_SHO1,0,-1,NULL,S_NULL,0,0}, //S_SHOPKEEPER1

//Remi
//"The Whackifier"
//One of these frames use the ori Sword animation
{SPR_FSD2,0,1,    A_WeaponReady, S_FSWORD2READY,0,0},	// S_FSWORD2READY
{SPR_FSD2,0,1,    A_Lower,       S_FSWORD2DOWN,0,0},    // S_FSWORD2DOWN
{SPR_FSD2,0,1,    A_Raise,       S_FSWORD2UP,0,0},	    // S_FSWORD2UP
{SPR_FSRD,3,4,    NULL,          S_FSWORD2ATK_2,5,36},  // S_FSWORD2ATK_1
{SPR_FSD2,1,3,    NULL,          S_FSWORD2ATK_3,5,36},  // S_FSWORD2ATK_2
//Replace later with real attack routines
{SPR_FSD2,2,3,    A_FAxeAttack,  S_FSWORD2ATK_4,5,36},  // S_FSWORD2ATK_3
{SPR_FSD2,3,3,    A_FAxeAttack,  S_FSWORD2ATK_5,5,36},	// S_FSWORD2ATK_4
{SPR_FSD2,4,3,    A_FAxeAttack,  S_FSWORD2ATK_6,5,36},  // S_FSWORD2ATK_5
{SPR_FSD2,0,12,   NULL,          S_FSWORD2ATK_7,0,90},  // S_FSWORD2ATK_6
{SPR_FSD2,0,1,    NULL,          S_FSWORD2ATK_8,0,60},  // S_FSWORD2ATK_7
{SPR_FSD2,0,1,    NULL,          S_FSWORD2ATK_9,0,55},  // S_FSWORD2ATK_8
{SPR_FSD2,0,1,    NULL,          S_FSWORD2ATK_10,0,50}, // S_FSWORD2ATK_9
{SPR_FSD2,0,1,    NULL,          S_FSWORD2ATK_11,0,45}, // S_FSWORD2ATK_10
{SPR_FSD2,0,1,    NULL,          S_FSWORD2READY,0,0},   // S_FSWORD2ATK_11

//--Possessions--
//Possessed Ettin
{SPR_ETTN,0,-1,   NULL,          S_NULL,0,0},	        // S_POSS_ETTIN
{SPR_ETTN,7,7,    A_Pain,        S_POSS_ETTIN,0,0},	    // S_POSS_ETTIN_PAIN1
{SPR_ETTN,4,6,    NULL,          S_POSS_ETTIN_ATK1_2,0,0},// S_POSS_ETTIN_ATK1_1
{SPR_ETTN,5,6,    NULL,          S_POSS_ETTIN_ATK1_3,0,0},// S_POSS_ETTIN_ATK1_2
{SPR_ETTN,6,8,    NULL,          S_POSS_ETTIN,0,0},	    // S_POSS_ETTIN_ATK1_3
//Ettin Mace
//hiding the weapon by drawing it offscreen
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_1ETTINREADY,0,0},// S_POSS_1ETTINREADY
{SPR_FSD2,5,1,    A_Lower,       S_POSS_1ETTINDOWN,0,0},// S_POSS_1ETTINDOWN
{SPR_FSD2,5,1,    A_Raise,       S_POSS_1ETTINUP,0,0},	// S_POSS_1ETTINUP
{SPR_FSD2,5,8,    NULL,          S_POSS_1ETTINATK_2,0,0},// S_POSS_1ETTINATK_1
{SPR_FSD2,5,1,    A_CMaceAttack, S_POSS_1ETTINATK_3,0,0},// S_POSS_1ETTINATK_2
{SPR_FSD2,5,12,   NULL,          S_POSS_1ETTINATK_4,0,0},// S_POSS_1ETTINATK_3
{SPR_FSD2,5,2,    A_ReFire,      S_POSS_1ETTINATK_5,0,0},// S_POSS_1ETTINATK_4
{SPR_FSD2,5,1,    NULL,          S_POSS_1ETTINREADY,0,0},// S_POSS_1ETTINATK_5
//Possessed Afrit
{SPR_FDMN,32772,-1,NULL,         S_NULL,0,0},	        // S_POSS_FIRED
{SPR_FDMN,32771,6,A_Pain,        S_POSS_FIRED,0,0},	    // S_POSS_FIRED_PAIN1
{SPR_FDMN,32778,3,NULL,          S_POSS_FIRED_ATTACK2,0,0},// S_POSS_FIRED_ATTACK1
{SPR_FDMN,32778,5,NULL,          S_POSS_FIRED_ATTACK3,0,0},// S_POSS_FIRED_ATTACK2
{SPR_FDMN,32778,5,NULL,          S_POSS_FIRED_ATTACK4,0,0},// S_POSS_FIRED_ATTACK3
{SPR_FDMN,32778,5,NULL,          S_POSS_FIRED,0,0},	    // S_POSS_FIRED_ATTACK4
//Afrit Triple Fireball
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_1AFRITREADY,0,0},// S_POSS_1AFRITREADY
{SPR_FSD2,5,1,    A_Lower,       S_POSS_1AFRITDOWN,0,0},// S_POSS_1AFRITDOWN
{SPR_FSD2,5,1,    A_Raise,       S_POSS_1AFRITUP,0,0},  // S_POSS_1AFRITUP
{SPR_FSD2,5,3,    NULL,          S_POSS_1AFRITATK_2,0,0},// S_POSS_1AFRITATK_1
{SPR_FSD2,5,5,    A_ProjFire,    S_POSS_1AFRITATK_3,0,0},// S_POSS_1AFRITATK_2
{SPR_FSD2,5,5,    A_ProjFire,    S_POSS_1AFRITATK_4,0,0},// S_POSS_1AFRITATK_3
{SPR_FSD2,5,5,    A_ProjFire,    S_POSS_1AFRITATK_5,0,0},// S_POSS_1AFRITATK_4
{SPR_FSD2,5,15,   NULL,          S_POSS_1AFRITATK_6,0,0},// S_POSS_1AFRITATK_5
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_1AFRITATK_7,0,0},// S_POSS_1AFRITATK_6
{SPR_FSD2,5,1,    NULL,          S_POSS_1AFRITREADY,0,0},// S_POSS_1AFRITATK_7
//Possessed Centaur & Centaur Leader
{SPR_CENT,1,-1,   NULL,          S_NULL,0,0},			// S_POSS_CENTAUR
{SPR_CENT,6,6,    A_Pain,        S_POSS_CENTAUR,0,0},	// S_POSS_CENTAUR_PAIN
{SPR_CENT,7,5,    NULL,			 S_POSS_CENTAUR_ATK2,0,0},// S_POSS_CENTAUR_ATK1
{SPR_CENT,8,4,    NULL,			 S_POSS_CENTAUR_ATK3,0,0},// S_POSS_CENTAUR_ATK2
{SPR_CENT,9,7,    NULL,			 S_POSS_CENTAUR_ATK4,0,0},// S_POSS_CENTAUR_ATK3
{SPR_CENT,4,10,   A_DontMove,	 S_POSS_CENTAUR_MISSILE2,0,0},// S_POSS_CENTAUR_MISSILE1
{SPR_CENT,32773,8,NULL,			 S_POSS_CENTAUR_MISSILE3,0,0},// S_POSS_CENTAUR_MISSILE2
{SPR_CENT,32773,1,A_MoveAgain,   S_POSS_CENTAUR_ATK4,0,0}, //S_POSS_CENTAUR_MISSILE3
{SPR_CENT,1,1,    NULL,			 S_POSS_CENTAUR,0,0},    //S_POSS_CENTAUR_ATK4
{SPR_CENT,4,1,    NULL,			 S_POSS_CENTAUR_BLOCK,0,0},//S_POSS_CENTAUR_BLOCK
//Centaur Sword Attack
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_1CENTAURREADY,0,0},// S_POSS_1CENTAURREADY
{SPR_FSD2,5,1,    A_Lower,       S_POSS_1CENTAURDOWN,0,0},// S_POSS_1CENTAURDOWN
{SPR_FSD2,5,1,    A_Raise,       S_POSS_1CENTAURUP,0,0},// S_POSS_1CENTAURUP
{SPR_FSD2,5,9,    NULL,          S_POSS_1CENTAURATK_2,0,0},// S_POSS_1CENTAURATK_1
{SPR_FSD2,5,7,    A_CMaceAttack, S_POSS_1CENTAURATK_3,0,0},// S_POSS_1CENTAURATK_2
{SPR_FSD2,5,5,    NULL,          S_POSS_1CENTAURATK_4,0,0},// S_POSS_1CENTAURATK_3
{SPR_FSD2,5,2,    A_ReFire,      S_POSS_1CENTAURREADY,0,0},// S_POSS_1CENTAURATK_4
//Centaur Shield
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_2CENTAURREADY,0,0},// S_POSS_2CENTAURREADY
{SPR_FSD2,5,1,    A_PUnSetReflective,S_POSS_2CENTAURDOWN2,0,0},// S_POSS_2CENTAURDOWN
{SPR_FSD2,5,1,    A_Lower,       S_POSS_2CENTAURDOWN2,0,0},// S_POSS_2CENTAURDOWN2
{SPR_FSD2,5,1,    A_PSetReflective,S_POSS_2CENTAURUP2,0,0},// S_POSS_2CENTAURUP
{SPR_FSD2,5,1,    A_Raise,       S_POSS_2CENTAURUP2,0,0},// S_POSS_2CENTAURUP2
{SPR_FSD2,5,1,    NULL,          S_POSS_2CENTAURREADY,0,0},// S_POSS_2CENTAURATK1
//Centaur Leader Missile Attack
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_3CENTAURREADY,0,0},// S_POSS_3CENTAURREADY
{SPR_FSD2,5,1,    A_Lower,       S_POSS_3CENTAURDOWN,0,0},// S_POSS_3CENTAURDOWN
{SPR_FSD2,5,1,    A_Raise,       S_POSS_3CENTAURUP,0,0},// S_POSS_3CENTAURUP
{SPR_FSD2,5,12,   NULL,          S_POSS_3CENTAURATK_2,0,0},// S_POSS_3CENTAURATK_1
{SPR_FSD2,5,7,    A_ProjFire,    S_POSS_3CENTAURATK_3,0,0},// S_POSS_3CENTAURATK_2
{SPR_FSD2,5,2,    NULL,          S_POSS_3CENTAURATK_4,0,0},// S_POSS_3CENTAURATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_3CENTAURREADY,0,0},// S_POSS_3CENTAURATK_4
//Possessed Iceguy
{SPR_ICEY,0,-1,   NULL,			 S_NULL,0,0},			// S_POSS_ICEGUY
{SPR_ICEY,0,1,    A_Pain,		 S_POSS_ICEGUY,0,0},	// S_POSS_ICEGUY_PAIN
{SPR_ICEY,4,3,    NULL,			 S_POSS_ICEGUY_ATK2,0,0},// S_POSS_ICEGUY_ATK1
{SPR_ICEY,5,3,    NULL,			 S_POSS_ICEGUY_ATK3,0,0},// S_POSS_ICEGUY_ATK2
{SPR_ICEY,32774,8,A_IceGuyAttack,S_POSS_ICEGUY_ATK4,0,0},// S_POSS_ICEGUY_ATK3
{SPR_ICEY,5,4,    NULL,			 S_POSS_ICEGUY,0,0},	// S_POSS_ICEGUY_ATK4
//Iceguy Missile Attack
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_1ICEGUYREADY,0,0},// S_POSS_1ICEGUYREADY
{SPR_FSD2,5,1,    A_Lower,       S_POSS_1ICEGUYDOWN,0,0},// S_POSS_1ICEGUYDOWN
{SPR_FSD2,5,1,    A_Raise,       S_POSS_1ICEGUYUP,0,0}, // S_POSS_1ICEGUYUP
{SPR_FSD2,5,6,    NULL,          S_POSS_1ICEGUYATK_2,0,0},// S_POSS_1ICEGUYATK_1
{SPR_FSD2,5,8,    A_ProjFire,    S_POSS_1ICEGUYATK_3,0,0},// S_POSS_1ICEGUYATK_2
{SPR_FSD2,5,5,    NULL,          S_POSS_1ICEGUYATK_4,0,0},// S_POSS_1ICEGUYATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_1ICEGUYREADY,0,0},// S_POSS_1ICEGUYATK_4
//Possessed Serpent
{SPR_DEMN,0,-1,	  NULL,			 S_NULL,0,0},			// S_POSS_DEMN
{SPR_DEMN,4,8,	  A_Pain,		 S_POSS_DEMN,0,0},		// S_POSS_DEMN_PAIN
{SPR_DEMN,4,6,	  NULL,			 S_POSS_DEMN_ATK1_2,0,0},// S_POSS_DEMN_ATK1_1
{SPR_DEMN,5,8,	  NULL,			 S_POSS_DEMN_ATK1_3,0,0},// S_POSS_DEMN_ATK1_2
{SPR_DEMN,6,6,	  NULL,			 S_POSS_DEMN,0,0},		// S_POSS_DEMN_ATK1_3
//Possessed Brown Serpent
{SPR_DEM2,0,-1,	  NULL,			 S_NULL,0,0},			// S_POSS_DEMN2
{SPR_DEM2,4,8,	  NULL,			 S_POSS_DEMN2,0,0},		// S_POSS_DEMN2_PAIN
{SPR_DEM2,4,6,	  NULL,			 S_POSS_DEMN2_ATK1_2,0,0},// S_POSS_DEMN2_ATK1_1
{SPR_DEM2,5,8,	  NULL,			 S_POSS_DEMN2_ATK1_3,0,0},// S_POSS_DEMN2_ATK1_2
{SPR_DEM2,6,6,	  NULL,			 S_POSS_DEMN2,0,0},		// S_POSS_DEMN2_ATK1_3
//Serpent Bite
{SPR_FSD2,5,1,	  A_WeaponReady, S_POSS_1SERPENTREADY,0,0},// S_POSS_1SERPENTREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_1SERPENTDOWN,0,0},// S_POSS_1SERPENTDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_1SERPENTUP,0,0},// S_POSS_1SERPENTUP
{SPR_FSD2,5,6,    NULL,          S_POSS_1SERPENTATK_2,0,0},// S_POSS_1SERPENTATK_1
{SPR_FSD2,5,8,    A_CMaceAttack, S_POSS_1SERPENTATK_3,0,0},// S_POSS_1SERPENTATK_2
{SPR_FSD2,5,11,   NULL,          S_POSS_1SERPENTATK_4,0,0},// S_POSS_1SERPENTATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_1SERPENTREADY,0,0},// S_POSS_1SERPENTATK_4
//Brown-/Serpent Missile/Fireball
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_2SERPENTREADY,0,0},// S_POSS_2SERPENTREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_2SERPENTDOWN,0,0},// S_POSS_2SERPENTDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_2SERPENTUP,0,0}, // S_POSS_2SERPENTUP
{SPR_FSD2,5,6,    NULL,          S_POSS_2SERPENTATK_2,0,0},// S_POSS_2SERPENTATK_1
{SPR_FSD2,5,8,    A_ProjFire,    S_POSS_2SERPENTATK_3,0,0},// S_POSS_2SERPENTATK_2
{SPR_FSD2,5,15,   NULL,          S_POSS_2SERPENTATK_4,0,0},// S_POSS_2SERPENTATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_2SERPENTREADY,0,0},// S_POSS_2SERPENTATK_4
//Possessed Wraith
{SPR_WRTH,0,15,   NULL,			 S_POSS_WRAITH_LOOK2,0,0},// S_POSS_WRAITH_LOOK1
{SPR_WRTH,1,15,   NULL,			 S_POSS_WRAITH_LOOK1,0,0},// S_POSS_WRAITH_LOOK2
{SPR_WRTH,4,6,	  NULL,			 S_POSS_WRAITH_ATK1_2,0,0},// S_POSS_WRAITH_ATK1_1
{SPR_WRTH,5,6,	  A_WraithFX3,	 S_POSS_WRAITH_ATK1_3,0,0},// S_POSS_WRAITH_ATK1_2
{SPR_WRTH,6,6,	  NULL,			 S_POSS_WRAITH_LOOK1,0,0},// S_POSS_WRAITH_ATK1_3
{SPR_WRTH,7,8,	  A_Pain,		 S_POSS_WRAITH_LOOK1,0,0},// S_POSS_WRAITH_PAIN
//Wraith Melee
{SPR_FSD2,5,1,	  A_WeaponReady, S_POSS_1WRAITHREADY,0,0},// S_POSS_1WRAITHREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_1WRAITHDOWN,0,0},// S_POSS_1WRAITHDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_1WRAITHUP,0,0}, // S_POSS_1WRAITHUP
{SPR_FSD2,5,7,    NULL,          S_POSS_1WRAITHATK_2,0,0},// S_POSS_1WRAITHATK_1
{SPR_FSD2,5,6,    A_CMaceAttack, S_POSS_1WRAITHATK_3,0,0},// S_POSS_1WRAITHATK_2
{SPR_FSD2,5,11,   NULL,          S_POSS_1WRAITHATK_4,0,0},// S_POSS_1WRAITHATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_1WRAITHREADY,0,0},// S_POSS_1WRAITHATK_4
//Wraith Fireball
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_2WRAITHREADY,0,0},// S_POSS_2WRAITHREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_2WRAITHDOWN,0,0},// S_POSS_2WRAITHDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_2WRAITHUP,0,0}, // S_POSS_2WRAITHUP
{SPR_FSD2,5,7,    NULL,          S_POSS_2WRAITHATK_2,0,0},// S_POSS_2WRAITHATK_1
{SPR_FSD2,5,6,    A_ProjFire,    S_POSS_2WRAITHATK_3,0,0},// S_POSS_2WRAITHATK_2
{SPR_FSD2,5,14,   NULL,          S_POSS_2WRAITHATK_4,0,0},// S_POSS_2WRAITHATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_2WRAITHREADY,0,0},// S_POSS_2WRAITHATK_4
//Possessed Bishop
{SPR_BISH,0,-1,	  NULL,			 S_NULL,0,0},			// S_POSS_BISHOP
{SPR_BISH,0,3,	  NULL,			 S_POSS_BISHOP_ATK2,0,0},// S_POSS_BISHOP_ATK1
{SPR_BISH,32771,3,NULL,			 S_POSS_BISHOP_ATK3,0,0},// S_POSS_BISHOP_ATK2
{SPR_BISH,32772,3,NULL,			 S_POSS_BISHOP_ATK4,0,0},// S_POSS_BISHOP_ATK3
{SPR_BISH,32773,3,A_PossBishWeapCheck,S_POSS_BISHOP_ATK5,0,0},// S_POSS_BISHOP_ATK4
{SPR_BISH,32773,5,NULL,			 S_POSS_BISHOP_ATK5,0,0},// S_POSS_BISHOP_ATK5
{SPR_BISH,2,6,	  A_Pain,		 S_POSS_BISHOP_PAIN2,0,0},// S_POSS_BISHOP_PAIN1
{SPR_BISH,2,6,	  NULL,			 S_POSS_BISHOP_PAIN3,0,0},// S_POSS_BISHOP_PAIN2
{SPR_BISH,2,6,	  NULL,			 S_POSS_BISHOP_PAIN4,0,0},// S_POSS_BISHOP_PAIN3
{SPR_BISH,2,6,	  NULL,			 S_POSS_BISHOP_PAIN5,0,0},// S_POSS_BISHOP_PAIN4
{SPR_BISH,2,0,	  NULL,			 S_POSS_BISHOP,0,0},	// S_POSS_BISHOP_PAIN5
//Bishop Melee
{SPR_FSD2,5,1,	  A_WeaponReady, S_POSS_1BISHOPREADY,0,0},// S_POSS_1BISHOPREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_1BISHOPDOWN,0,0},// S_POSS_1BISHOPDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_1BISHOPUP,0,0}, // S_POSS_1BISHOPUP
{SPR_FSD2,5,6,    NULL,          S_POSS_1BISHOPATK_2,0,0},// S_POSS_1BISHOPATK_1
{SPR_FSD2,5,6,    A_CMaceAttack, S_POSS_1BISHOPATK_3,0,0},// S_POSS_1BISHOPATK_2
{SPR_FSD2,5,18,   NULL,          S_POSS_1BISHOPATK_4,0,0},// S_POSS_1BISHOPATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_1BISHOPREADY,0,0},// S_POSS_1BISHOPATK_4
//Bishop Swirly Missiles
{SPR_FSD2,5,1,    A_WeaponReady, S_POSS_2BISHOPREADY,0,0},// S_POSS_2BISHOPREADY
{SPR_FSD2,5,1,	  A_Lower,       S_POSS_2BISHOPDOWN,0,0},// S_POSS_2BISHOPDOWN
{SPR_FSD2,5,1,	  A_Raise,       S_POSS_2BISHOPUP,0,0}, // S_POSS_2BISHOPUP
{SPR_FSD2,5,7,    A_PossBishStart,S_POSS_2BISHOPATK_2,0,0},// S_POSS_2BISHOPATK_1
{SPR_FSD2,5,5,    A_ProjFire,    S_POSS_2BISHOPATK_2,0,0},// S_POSS_2BISHOPATK_2
{SPR_FSD2,5,14,   NULL,          S_POSS_2BISHOPATK_4,0,0},// S_POSS_2BISHOPATK_3
{SPR_FSD2,5,1,    A_ReFire,      S_POSS_2BISHOPREADY,0,0},// S_POSS_2BISHOPATK_4
//For the Spirits Within spell
{SPR_MNSM,0,3,NULL,S_SPIRWITHSMOKE2,0,0},	// S_SPIRWITHSMOKE1
{SPR_MNSM,1,3,NULL,S_SPIRWITHSMOKE3,0,0},	// S_SPIRWITHSMOKE2
{SPR_MNSM,2,3,NULL,S_SPIRWITHSMOKE4,0,0},	// S_SPIRWITHSMOKE3
{SPR_MNSM,3,3,NULL,S_SPIRWITHSMOKE5,0,0},	// S_SPIRWITHSMOKE4
{SPR_MNSM,4,3,NULL,S_SPIRWITHSMOKE6,0,0},	// S_SPIRWITHSMOKE5
{SPR_MNSM,3,3,NULL,S_SPIRWITHSMOKE7,0,0},	// S_SPIRWITHSMOKE6
{SPR_MNSM,2,3,NULL,S_SPIRWITHSMOKE8,0,0},	// S_SPIRWITHSMOKE7
{SPR_MNSM,1,3,NULL,S_SPIRWITHSMOKE9,0,0},	// S_SPIRWITHSMOKE8
{SPR_MNSM,0,3,NULL,S_NULL,0,0},				// S_SPIRWITHSMOKE9
//Black Mage Wand
{SPR_MWN2,0,1,	  A_WeaponReady,	S_MWAND2READY,0,0},					// S_MWAND2READY
{SPR_MWN2,0,1,	  A_Lower,			S_MWAND2DOWN,0,0},					// S_MWAND2DOWN
{SPR_MWN2,0,1,	  A_Raise,			S_MWAND2UP,0,0},					// S_MWAND2UP
{SPR_MWN2,0,6,	  NULL,				S_MWAND2ATK_2,0,0},					// S_MWAND2ATK_1
{SPR_MWN2,32769,6,A_MWandAttack,	S_MWAND2ATK_3,0,48},				// S_MWAND2ATK_2
{SPR_MWN2,0,10,	  NULL,				S_MWAND2ATK_4,0,40},				// S_MWAND2ATK_3
{SPR_MWN2,0,3,	  A_ReFire,			S_MWAND2READY,0,36},				// S_MWAND2ATK_4
{SPR_MWN2,32772,4,NULL,				S_MWAND2PUFF2,0,0},					// S_MWAND2PUFF1
{SPR_MWN2,32773,3,NULL,				S_MWAND2PUFF3,0,0},					// S_MWAND2PUFF2
{SPR_MWN2,32774,4,NULL,				S_MWAND2PUFF4,0,0},					// S_MWAND2PUFF3
{SPR_MWN2,32775,3,NULL,				S_MWAND2PUFF5,0,0},					// S_MWAND2PUFF4
{SPR_MWN2,32776,4,NULL,				S_NULL,0,0},						// S_MWAND2PUFF5
{SPR_MWN2,32770,4,NULL,				S_MWAND2SMOKE2,0,0},				// S_MWAND2SMOKE1
{SPR_MWN2,32771,4,NULL,				S_MWAND2SMOKE3,0,0},				// S_MWAND2SMOKE2
{SPR_MWN2,32770,4,NULL,				S_MWAND2SMOKE4,0,0},				// S_MWAND2SMOKE3
{SPR_MWN2,32771,4,NULL,				S_NULL,0,0},						// S_MWAND2SMOKE4
{SPR_MWN2,32770,4,NULL,				S_MWAND2_MISSILE2,0,0},				// S_MWAND2_MISSILE1
{SPR_MWN2,32771,4,NULL,				S_MWAND2_MISSILE1,0,0},				// S_MWAND2_MISSILE2
//Red Mage Wand
{SPR_MWN3,0,1,	  A_WeaponReady,	S_MWAND3READY,0,0},					// S_MWAND3READY
{SPR_MWN3,0,1,	  A_Lower,			S_MWAND3DOWN,0,0},					// S_MWAND3DOWN
{SPR_MWN3,0,1,	  A_Raise,			S_MWAND3UP,0,0},					// S_MWAND3UP
{SPR_MWN3,0,6,	  NULL,				S_MWAND3ATK_2,0,0},					// S_MWAND3ATK_1
{SPR_MWN3,32769,2,A_MWandAttack,	S_MWAND3ATK_3,0,48},				// S_MWAND3ATK_2
{SPR_MWN3,0,2,	  NULL,				S_MWAND3ATK_4,0,40},				// S_MWAND3ATK_3
{SPR_MWN3,32769,2,A_MWandAttack,	S_MWAND3ATK_5,0,48},				// S_MWAND3ATK_4
{SPR_MWN3,0,2,	  NULL,				S_MWAND3ATK_6,0,40},				// S_MWAND3ATK_5
{SPR_MWN3,32769,2,A_MWandAttack,	S_MWAND3ATK_7,0,48},				// S_MWAND3ATK_6
{SPR_MWN3,0,8,	  NULL,				S_MWAND3ATK_8,0,40},				// S_MWAND3ATK_7
{SPR_MWN3,0,3,	  A_ReFire,			S_MWAND3READY,0,36},				// S_MWAND3ATK_8
{SPR_MWN3,32772,4,NULL,				S_MWAND3PUFF2,0,0},					// S_MWAND3PUFF1
{SPR_MWN3,32773,3,NULL,				S_MWAND3PUFF3,0,0},					// S_MWAND3PUFF2
{SPR_MWN3,32774,4,NULL,				S_MWAND3PUFF4,0,0},					// S_MWAND3PUFF3
{SPR_MWN3,32775,3,NULL,				S_MWAND3PUFF5,0,0},					// S_MWAND3PUFF4
{SPR_MWN3,32776,4,NULL,				S_NULL,0,0},						// S_MWAND3PUFF5
{SPR_MWN3,2,4,	  NULL,				S_MWAND3SMOKE2,0,0},				// S_MWAND3SMOKE1
{SPR_MWN3,3,4,	  NULL,				S_MWAND3SMOKE3,0,0},				// S_MWAND3SMOKE2
{SPR_MWN3,2,4,	  NULL,				S_MWAND3SMOKE4,0,0},				// S_MWAND3SMOKE3
{SPR_MWN3,3,4,	  NULL,				S_NULL,0,0},						// S_MWAND3SMOKE4
{SPR_MWN3,32770,4,NULL,				S_MWAND3_MISSILE2,0,0},				// S_MWAND3_MISSILE1
{SPR_MWN3,32771,4,NULL,				S_MWAND3_MISSILE1,0,0},				// S_MWAND3_MISSILE2
//Yellow Mage Wand
{SPR_MWN4,0,1,	  A_WeaponReady,	S_MWAND4READY,0,0},					// S_MWAND4READY
{SPR_MWN4,0,1,	  A_Lower,			S_MWAND4DOWN,0,0},					// S_MWAND4DOWN
{SPR_MWN4,0,1,	  A_Raise,			S_MWAND4UP,0,0},					// S_MWAND4UP
{SPR_MWN4,0,6,	  NULL,				S_MWAND4ATK_2,0,0},					// S_MWAND4ATK_1
{SPR_MWN4,32769,6,A_MWandAttack,	S_MWAND4ATK_3,0,48},				// S_MWAND4ATK_2
{SPR_MWN4,0,5,	  NULL,				S_MWAND4ATK_4,0,40},				// S_MWAND4ATK_3
{SPR_MWN4,0,3,	  A_ReFire,			S_MWAND4READY,0,36},				// S_MWAND4ATK_4
{SPR_MWN4,32772,4,NULL,				S_MWAND4PUFF2,0,0},					// S_MWAND4PUFF1
{SPR_MWN4,32773,3,NULL,				S_MWAND4PUFF3,0,0},					// S_MWAND4PUFF2
{SPR_MWN4,32774,4,NULL,				S_MWAND4PUFF4,0,0},					// S_MWAND4PUFF3
{SPR_MWN4,32775,3,NULL,				S_MWAND4PUFF5,0,0},					// S_MWAND4PUFF4
{SPR_MWN4,32776,4,NULL,				S_NULL,0,0},						// S_MWAND4PUFF5
{SPR_MWN4,32770,4,NULL,				S_MWAND4_MISSILE2,0,0},				// S_MWAND4_MISSILE1
{SPR_MWN4,32771,4,NULL,				S_MWAND4_MISSILE1,0,0},				// S_MWAND4_MISSILE2
//Corvus Staff
{SPR_CSTF,0,1,A_WeaponReady,S_STAFFREADY,0,0},	// S_STAFFREADY
{SPR_CSTF,0,1,A_Lower,S_STAFFDOWN,0,0},	// S_STAFFDOWN
{SPR_CSTF,0,1,A_Raise,S_STAFFUP,0,0},	// S_STAFFUP
{SPR_CSTF,3,4,A_WeaponReady,S_STAFFREADY2_2,0,0},	// S_STAFFREADY2_1
{SPR_CSTF,4,4,A_WeaponReady,S_STAFFREADY2_3,0,0},	// S_STAFFREADY2_2
{SPR_CSTF,5,4,A_WeaponReady,S_STAFFREADY2_1,0,0},	// S_STAFFREADY2_3
{SPR_CSTF,3,1,A_Lower,S_STAFFDOWN2,0,0},	// S_STAFFDOWN2
{SPR_CSTF,3,1,A_Raise,S_STAFFUP2,0,0},	// S_STAFFUP2
{SPR_CSTF,1,6,NULL,S_STAFFATK1_2,0,0},	// S_STAFFATK1_1
{SPR_CSTF,2,8,A_StaffAttackPL1,S_STAFFATK1_3,0,0},	// S_STAFFATK1_2
{SPR_CSTF,1,8,A_ReFire,S_STAFFREADY,0,0},	// S_STAFFATK1_3
{SPR_CSTF,6,6,NULL,S_STAFFATK2_2,0,0},	// S_STAFFATK2_1
{SPR_CSTF,7,8,A_StaffAttackPL2,S_STAFFATK2_3,0,0},	// S_STAFFATK2_2
{SPR_CSTF,6,8,A_ReFire,S_STAFFREADY2_1,0,0},	// S_STAFFATK2_3
{SPR_CSTF,8+32768,4,NULL,S_STAFFPUFF2,0,0},	// S_STAFFPUFF1
{SPR_CSTF,1+8,4,NULL,S_STAFFPUFF3,0,0},	// S_STAFFPUFF2
{SPR_CSTF,2+8,4,NULL,S_STAFFPUFF4,0,0},	// S_STAFFPUFF3
{SPR_CSTF,3+8,4,NULL,S_NULL,0,0},	// S_STAFFPUFF4
{SPR_CSTF,12+32768,4,NULL,S_STAFFPUFF2_2,0,0},	// S_STAFFPUFF2_1
{SPR_CSTF,12+32769,4,NULL,S_STAFFPUFF2_3,0,0},	// S_STAFFPUFF2_2
{SPR_CSTF,12+32770,4,NULL,S_STAFFPUFF2_4,0,0},	// S_STAFFPUFF2_3
{SPR_CSTF,12+32771,4,NULL,S_STAFFPUFF2_5,0,0},	// S_STAFFPUFF2_4
{SPR_CSTF,12+32772,4,NULL,S_STAFFPUFF2_6,0,0},	// S_STAFFPUFF2_5
{SPR_CSTF,12+32773,4,NULL,S_NULL,0,0},	// S_STAFFPUFF2_6
//Corvus Gauntlets
{SPR_CGAU,0,1,A_WeaponReady,S_GAUNTLETREADY,0,0},	// S_GAUNTLETREADY
{SPR_CGAU,0,1,A_Lower,S_GAUNTLETDOWN,0,0},	// S_GAUNTLETDOWN
{SPR_CGAU,0,1,A_Raise,S_GAUNTLETUP,0,0},	// S_GAUNTLETUP
{SPR_CGAU,6,4,A_WeaponReady,S_GAUNTLETREADY2_2,0,0},	// S_GAUNTLETREADY2_1
{SPR_CGAU,7,4,A_WeaponReady,S_GAUNTLETREADY2_3,0,0},	// S_GAUNTLETREADY2_2
{SPR_CGAU,8,4,A_WeaponReady,S_GAUNTLETREADY2_1,0,0},	// S_GAUNTLETREADY2_3
{SPR_CGAU,6,1,A_Lower,S_GAUNTLETDOWN2,0,0},	// S_GAUNTLETDOWN2
{SPR_CGAU,6,1,A_Raise,S_GAUNTLETUP2,0,0},	// S_GAUNTLETUP2
{SPR_CGAU,1,4,NULL,S_GAUNTLETATK1_2,0,0},	// S_GAUNTLETATK1_1
{SPR_CGAU,2,4,NULL,S_GAUNTLETATK1_3,0,0},	// S_GAUNTLETATK1_2
{SPR_CGAU,32771,4,A_GauntletAttack,S_GAUNTLETATK1_4,0,0},	// S_GAUNTLETATK1_3
{SPR_CGAU,32772,4,A_GauntletAttack,S_GAUNTLETATK1_5,0,0},	// S_GAUNTLETATK1_4
{SPR_CGAU,32773,4,A_GauntletAttack,S_GAUNTLETATK1_6,0,0},	// S_GAUNTLETATK1_5
{SPR_CGAU,2,4,A_ReFire,S_GAUNTLETATK1_7,0,0},	// S_GAUNTLETATK1_6
{SPR_CGAU,1,4,A_Light0,S_GAUNTLETREADY,0,0},	// S_GAUNTLETATK1_7
{SPR_CGAU,9,4,NULL,S_GAUNTLETATK2_2,0,0},	// S_GAUNTLETATK2_1
{SPR_CGAU,10,4,NULL,S_GAUNTLETATK2_3,0,0},	// S_GAUNTLETATK2_2
{SPR_CGAU,32779,4,A_GauntletAttack,S_GAUNTLETATK2_4,0,0},	// S_GAUNTLETATK2_3
{SPR_CGAU,32780,4,A_GauntletAttack,S_GAUNTLETATK2_5,0,0},	// S_GAUNTLETATK2_4
{SPR_CGAU,32781,4,A_GauntletAttack,S_GAUNTLETATK2_6,0,0},	// S_GAUNTLETATK2_5
{SPR_CGAU,10,4,A_ReFire,S_GAUNTLETATK2_7,0,0},	// S_GAUNTLETATK2_6
{SPR_CGAU,9,4,A_Light0,S_GAUNTLETREADY2_1,0,0},	// S_GAUNTLETATK2_7
{SPR_CGAU,14+32768,4,NULL,S_GAUNTLETPUFF1_2,0,0},	// S_GAUNTLETPUFF1_1
{SPR_CGAU,14+32769,4,NULL,S_GAUNTLETPUFF1_3,0,0},	// S_GAUNTLETPUFF1_2
{SPR_CGAU,14+32770,4,NULL,S_GAUNTLETPUFF1_4,0,0},	// S_GAUNTLETPUFF1_3
{SPR_CGAU,14+32771,4,NULL,S_NULL,0,0},	// S_GAUNTLETPUFF1_4
{SPR_CGAU,14+32772,4,NULL,S_GAUNTLETPUFF2_2,0,0},	// S_GAUNTLETPUFF2_1
{SPR_CGAU,14+32773,4,NULL,S_GAUNTLETPUFF2_3,0,0},	// S_GAUNTLETPUFF2_2
{SPR_CGAU,14+32774,4,NULL,S_GAUNTLETPUFF2_4,0,0},	// S_GAUNTLETPUFF2_3
{SPR_CGAU,14+32775,4,NULL,S_NULL,0,0},	// S_GAUNTLETPUFF2_4
//Corvus Mace
{SPR_CMAC,0,1,A_WeaponReady,S_MACEREADY,0,0},	// S_MACEREADY
{SPR_CMAC,0,1,A_Lower,S_MACEDOWN,0,0},	// S_MACEDOWN
{SPR_CMAC,0,1,A_Raise,S_MACEUP,0,0},	// S_MACEUP
{SPR_CMAC,1,4,NULL,S_MACEATK1_2,0,0},	// S_MACEATK1_1
{SPR_CMAC,2,3,A_FireMacePL1,S_MACEATK1_3,0,0},	// S_MACEATK1_2
{SPR_CMAC,3,3,A_FireMacePL1,S_MACEATK1_4,0,0},	// S_MACEATK1_3
{SPR_CMAC,4,3,A_FireMacePL1,S_MACEATK1_5,0,0},	// S_MACEATK1_4
{SPR_CMAC,5,3,A_FireMacePL1,S_MACEATK1_6,0,0},	// S_MACEATK1_5
{SPR_CMAC,2,4,A_ReFire,S_MACEATK1_7,0,0},	// S_MACEATK1_6
{SPR_CMAC,3,4,NULL,S_MACEATK1_8,0,0},	// S_MACEATK1_7
{SPR_CMAC,4,4,NULL,S_MACEATK1_9,0,0},	// S_MACEATK1_8
{SPR_CMAC,5,4,NULL,S_MACEATK1_10,0,0},	// S_MACEATK1_9
{SPR_CMAC,1,4,NULL,S_MACEREADY,0,0},	// S_MACEATK1_10
{SPR_CMAC,1,4,NULL,S_MACEATK2_2,0,0},	// S_MACEATK2_1
{SPR_CMAC,3,4,A_FireMacePL2,S_MACEATK2_3,0,0},	// S_MACEATK2_2
{SPR_CMAC,1,4,NULL,S_MACEATK2_4,0,0},	// S_MACEATK2_3
{SPR_CMAC,0,8,A_ReFire,S_MACEREADY,0,0},	// S_MACEATK2_4
{SPR_CMAC,6+0,4,A_MacePL1Check,S_MACEFX1_2,0,0},	// S_MACEFX1_1
{SPR_CMAC,6+1,4,A_MacePL1Check,S_MACEFX1_1,0,0},	// S_MACEFX1_2
{SPR_CMAC,6+32773,4,A_MaceBallImpact,S_MACEFXI1_2,0,0},	// S_MACEFXI1_1
{SPR_CMAC,6+32774,4,NULL,S_MACEFXI1_3,0,0},	// S_MACEFXI1_2
{SPR_CMAC,6+32775,4,NULL,S_MACEFXI1_4,0,0},	// S_MACEFXI1_3
{SPR_CMAC,6+32776,4,NULL,S_MACEFXI1_5,0,0},	// S_MACEFXI1_4
{SPR_CMAC,6+32777,4,NULL,S_NULL,0,0},	// S_MACEFXI1_5
{SPR_CMAC,6+2,4,NULL,S_MACEFX2_2,0,0},	// S_MACEFX2_1
{SPR_CMAC,6+3,4,NULL,S_MACEFX2_1,0,0},	// S_MACEFX2_2
{SPR_CMAC,6+32773,4,A_MaceBallImpact2,S_MACEFXI1_2,0,0},	// S_MACEFXI2_1
{SPR_CMAC,6+0,4,NULL,S_MACEFX3_2,0,0},	// S_MACEFX3_1
{SPR_CMAC,6+1,4,NULL,S_MACEFX3_1,0,0},	// S_MACEFX3_2
{SPR_CMAC,6+4,99,NULL,S_MACEFX4_1,0,0},	// S_MACEFX4_1
{SPR_CMAC,6+32770,4,A_DeathBallImpact,S_MACEFXI1_2,0,0},	// S_MACEFXI4_1
//Corvus Gold Wand
{SPR_CWND,0,1,A_WeaponReady,S_GOLDWANDREADY,0,0},	// S_GOLDWANDREADY
{SPR_CWND,0,1,A_Lower,S_GOLDWANDDOWN,0,0},	// S_GOLDWANDDOWN
{SPR_CWND,0,1,A_Raise,S_GOLDWANDUP,0,0},	// S_GOLDWANDUP
{SPR_CWND,1,3,NULL,S_GOLDWANDATK1_2,0,0},	// S_GOLDWANDATK1_1
{SPR_CWND,2,5,A_FireGoldWandPL1,S_GOLDWANDATK1_3,0,0},	// S_GOLDWANDATK1_2
{SPR_CWND,3,3,NULL,S_GOLDWANDATK1_4,0,0},	// S_GOLDWANDATK1_3
{SPR_CWND,3,0,A_ReFire,S_GOLDWANDREADY,0,0},	// S_GOLDWANDATK1_4
{SPR_CWND,1,3,NULL,S_GOLDWANDATK2_2,0,0},	// S_GOLDWANDATK2_1
{SPR_CWND,2,4,A_FireGoldWandPL2,S_GOLDWANDATK2_3,0,0},	// S_GOLDWANDATK2_2
{SPR_CWND,3,3,NULL,S_GOLDWANDATK2_4,0,0},	// S_GOLDWANDATK2_3
{SPR_CWND,3,0,A_ReFire,S_GOLDWANDREADY,0,0},	// S_GOLDWANDATK2_4
{SPR_CWND,9+32768,6,NULL,S_GWANDFX1_2,0,0},	// S_GWANDFX1_1
{SPR_CWND,9+32769,6,NULL,S_GWANDFX1_1,0,0},	// S_GWANDFX1_2
{SPR_CWND,9+32772,3,NULL,S_GWANDFXI1_2,0,0},	// S_GWANDFXI1_1
{SPR_CWND,9+32773,3,NULL,S_GWANDFXI1_3,0,0},	// S_GWANDFXI1_2
{SPR_CWND,9+32774,3,NULL,S_GWANDFXI1_4,0,0},	// S_GWANDFXI1_3
{SPR_CWND,9+32775,3,NULL,S_NULL,0,0},	// S_GWANDFXI1_4
{SPR_CWND,9+32770,6,NULL,S_GWANDFX2_2,0,0},	// S_GWANDFX2_1
{SPR_CWND,9+32771,6,NULL,S_GWANDFX2_1,0,0},	// S_GWANDFX2_2
{SPR_CWND,4+32768,3,NULL,S_GWANDPUFF1_2,0,0},	// S_GWANDPUFF1_1
{SPR_CWND,4+32769,3,NULL,S_GWANDPUFF1_3,0,0},	// S_GWANDPUFF1_2
{SPR_CWND,4+32770,3,NULL,S_GWANDPUFF1_4,0,0},	// S_GWANDPUFF1_3
{SPR_CWND,4+32771,3,NULL,S_GWANDPUFF1_5,0,0},	// S_GWANDPUFF1_4
{SPR_CWND,4+32772,3,NULL,S_NULL,0,0},	// S_GWANDPUFF1_5
//Corvus Crossbow
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW2,0,0},	// S_CRBOW1
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW3,0,0},	// S_CRBOW2
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW4,0,0},	// S_CRBOW3
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW5,0,0},	// S_CRBOW4
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW6,0,0},	// S_CRBOW5
{SPR_CBOW,0,1,A_WeaponReady,S_CRBOW7,0,0},	// S_CRBOW6
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW8,0,0},	// S_CRBOW7
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW9,0,0},	// S_CRBOW8
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW10,0,0},	// S_CRBOW9
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW11,0,0},	// S_CRBOW10
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW12,0,0},	// S_CRBOW11
{SPR_CBOW,1,1,A_WeaponReady,S_CRBOW13,0,0},	// S_CRBOW12
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW14,0,0},	// S_CRBOW13
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW15,0,0},	// S_CRBOW14
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW16,0,0},	// S_CRBOW15
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW17,0,0},	// S_CRBOW16
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW18,0,0},	// S_CRBOW17
{SPR_CBOW,2,1,A_WeaponReady,S_CRBOW1,0,0},	// S_CRBOW18
{SPR_CBOW,0,1,A_Lower,S_CRBOWDOWN,0,0},	// S_CRBOWDOWN
{SPR_CBOW,0,1,A_Raise,S_CRBOWUP,0,0},	// S_CRBOWUP
{SPR_CBOW,3,6,A_FireCrossbowPL1,S_CRBOWATK1_2,0,0},	// S_CRBOWATK1_1
{SPR_CBOW,4,3,NULL,S_CRBOWATK1_3,0,0},	// S_CRBOWATK1_2
{SPR_CBOW,5,3,NULL,S_CRBOWATK1_4,0,0},	// S_CRBOWATK1_3
{SPR_CBOW,6,3,NULL,S_CRBOWATK1_5,0,0},	// S_CRBOWATK1_4
{SPR_CBOW,7,3,NULL,S_CRBOWATK1_6,0,0},	// S_CRBOWATK1_5
{SPR_CBOW,0,4,NULL,S_CRBOWATK1_7,0,0},	// S_CRBOWATK1_6
{SPR_CBOW,1,4,NULL,S_CRBOWATK1_8,0,0},	// S_CRBOWATK1_7
{SPR_CBOW,2,5,A_ReFire,S_CRBOW1,0,0},	// S_CRBOWATK1_8
{SPR_CBOW,3,5,A_FireCrossbowPL2,S_CRBOWATK2_2,0,0},	// S_CRBOWATK2_1
{SPR_CBOW,4,3,NULL,S_CRBOWATK2_3,0,0},	// S_CRBOWATK2_2
{SPR_CBOW,5,2,NULL,S_CRBOWATK2_4,0,0},	// S_CRBOWATK2_3
{SPR_CBOW,6,3,NULL,S_CRBOWATK2_5,0,0},	// S_CRBOWATK2_4
{SPR_CBOW,7,2,NULL,S_CRBOWATK2_6,0,0},	// S_CRBOWATK2_5
{SPR_CBOW,0,3,NULL,S_CRBOWATK2_7,0,0},	// S_CRBOWATK2_6
{SPR_CBOW,1,3,NULL,S_CRBOWATK2_8,0,0},	// S_CRBOWATK2_7
{SPR_CBOW,2,4,A_ReFire,S_CRBOW1,0,0},	// S_CRBOWATK2_8
{SPR_CBOW,8+32769,1,NULL,S_CRBOWFX1,0,0},	// S_CRBOWFX1
{SPR_CBOW,8+32775,8,NULL,S_CRBOWFXI1_2,0,0},	// S_CRBOWFXI1_1
{SPR_CBOW,8+32776,8,NULL,S_CRBOWFXI1_3,0,0},	// S_CRBOWFXI1_2
{SPR_CBOW,8+32777,8,NULL,S_NULL,0,0},	// S_CRBOWFXI1_3
{SPR_CBOW,8+32769,1,A_BoltSpark,S_CRBOWFX2,0,0},	// S_CRBOWFX2
{SPR_CBOW,8+32768,1,NULL,S_CRBOWFX3,0,0},	// S_CRBOWFX3
{SPR_CBOW,8+32770,8,NULL,S_CRBOWFXI3_2,0,0},	// S_CRBOWFXI3_1
{SPR_CBOW,8+32771,8,NULL,S_CRBOWFXI3_3,0,0},	// S_CRBOWFXI3_2
{SPR_CBOW,8+32772,8,NULL,S_NULL,0,0},	// S_CRBOWFXI3_3
{SPR_CBOW,8+32773,8,NULL,S_CRBOWFX4_2,0,0},	// S_CRBOWFX4_1
{SPR_CBOW,8+32774,8,NULL,S_NULL,0,0},	// S_CRBOWFX4_2

{SPR_TRNG,32772,5,NULL,S_POSS_PROJ_FX2,0,0},	// S_POSS_PROJ_FX1
{SPR_TRNG,32771,4,NULL,S_POSS_PROJ_FX3,0,0},	// S_POSS_PROJ_FX2
{SPR_TRNG,32770,3,NULL,S_POSS_PROJ_FX4,0,0},	// S_POSS_PROJ_FX3
{SPR_TRNG,32769,3,NULL,S_POSS_PROJ_FX5,0,0},	// S_POSS_PROJ_FX4
{SPR_TRNG,32768,3,NULL,S_POSS_PROJ_FX6,0,0},	// S_POSS_PROJ_FX5
{SPR_TRNG,32769,3,NULL,S_POSS_PROJ_FX7,0,0},	// S_POSS_PROJ_FX6
{SPR_TRNG,32770,3,A_PossProjSpawn,S_POSS_PROJ_FX8,0,0},	// S_POSS_PROJ_FX7
{SPR_TRNG,32771,3,NULL,S_POSS_PROJ_FX3,0,0},	// S_POSS_PROJ_FX8
{SPR_TRNG,32772,3,NULL,S_NULL,0,0},	// S_POSS_PROJ_FX9

{SPR_TRNG,32772,4,NULL,S_SUMMONMONSTER1,0,0},				// S_SUMMONMONSTER1
{SPR_TRNG,32772,4,A_SummonMonster,S_NULL,0,0},	// S_SUMMONMONSTER2
...
{SPR_CMAG,0,4,A_NPCWalk,S_CMAGE_WALK3,0,0},	// S_CMAGE_WALK2
{SPR_CMAG,1,4,A_NPCWalk,S_CMAGE_WALK4,0,0},	// S_CMAGE_WALK3
{SPR_CMAG,1,4,A_NPCWalk,S_CMAGE_WALK5,0,0},	// S_CMAGE_WALK4
{SPR_CMAG,2,4,A_NPCWalk,S_CMAGE_WALK6,0,0},	// S_CMAGE_WALK5
{SPR_CMAG,2,4,A_NPCWalk,S_CMAGE_WALK7,0,0},	// S_CMAGE_WALK6
{SPR_CMAG,3,4,A_NPCWalk,S_CMAGE_WALK8,0,0},	// S_CMAGE_WALK7
{SPR_CMAG,3,4,A_NPCWalk,S_CMAGE_WALK1,0,0},	// S_CMAGE_WALK8
// Red Demon
{SPR_RDMN,0,10,A_Look,S_RDMN_LOOK2,0,0},	// S_RDMN_LOOK1
{SPR_RDMN,0,10,A_Look,S_RDMN_LOOK1,0,0},	// S_RDMN_LOOK2
{SPR_RDMN,0,4,A_Chase,S_RDMN_CHASE2,0,0},	// S_RDMN_CHASE1
{SPR_RDMN,1,4,A_Chase,S_RDMN_CHASE3,0,0},	// S_RDMN_CHASE2
{SPR_RDMN,2,4,A_Chase,S_RDMN_CHASE4,0,0},	// S_RDMN_CHASE3
{SPR_RDMN,3,4,A_Chase,S_RDMN_CHASE1,0,0},	// S_RDMN_CHASE4
{SPR_RDMN,4,6,A_FaceTarget,S_RDMN_ATK1_2,0,0},	// S_RDMN_ATK1_1
{SPR_RDMN,5,8,A_FaceTarget,S_RDMN_ATK1_3,0,0},	// S_RDMN_ATK1_2
{SPR_RDMN,6,6,A_Demon3Attack1,S_RDMN_CHASE1,0,0},	// S_RDMN_ATK1_3
{SPR_RDMN,4,5,A_FaceTarget,S_RDMN_ATK2_2,0,0},	// S_RDMN_ATK2_1
{SPR_RDMN,5,6,A_FaceTarget,S_RDMN_ATK2_3,0,0},	// S_RDMN_ATK2_2
{SPR_RDMN,6,5,A_Demon3Attack2,S_RDMN_CHASE1,0,0},	// S_RDMN_ATK2_3
{SPR_RDMN,4,4,NULL,S_RDMN_PAIN2,0,0},	// S_RDMN_PAIN1
{SPR_RDMN,4,4,A_Pain,S_RDMN_CHASE1,0,0},	// S_RDMN_PAIN2
// Start damaged states
{SPR_RDMN,16,10,A_Look,S_RDMN_DAMAGED_LOOK2,0,0},	// S_RDMN_DAMAGED_LOOK1
{SPR_RDMN,16,10,A_Look,S_RDMN_DAMAGED_LOOK1,0,0},	// S_RDMN_DAMAGED_LOOK2
{SPR_RDMN,16,4,A_Chase,S_RDMN_DAMAGED_CHASE2,0,0},	// S_RDMN_DAMAGED_CHASE1
{SPR_RDMN,17,4,A_Chase,S_RDMN_DAMAGED_CHASE3,0,0},	// S_RDMN_DAMAGED_CHASE2
{SPR_RDMN,18,4,A_Chase,S_RDMN_DAMAGED_CHASE4,0,0},	// S_RDMN_DAMAGED_CHASE3
{SPR_RDMN,19,4,A_Chase,S_RDMN_DAMAGED_CHASE1,0,0},	// S_RDMN_DAMAGED_CHASE4
{SPR_RDMN,20,6,A_FaceTarget,S_RDMN_DAMAGED_ATK1_2,0,0},	// S_RDMN_DAMAGED_ATK1_1
{SPR_RDMN,21,8,A_FaceTarget,S_RDMN_DAMAGED_ATK1_3,0,0},	// S_RDMN_DAMAGED_ATK1_2
{SPR_RDMN,22,6,A_Demon3Attack1,S_RDMN_DAMAGED_CHASE1,0,0},	// S_RDMN_DAMAGED_ATK1_3
{SPR_RDMN,20,5,A_FaceTarget,S_RDMN_DAMAGED_ATK2_2,0,0},	// S_RDMN_DAMAGED_ATK2_1
{SPR_RDMN,21,6,A_FaceTarget,S_RDMN_DAMAGED_ATK2_3,0,0},	// S_RDMN_DAMAGED_ATK2_2
{SPR_RDMN,22,5,A_Demon3Attack2,S_RDMN_DAMAGED_CHASE1,0,0},	// S_RDMN_DAMAGED_ATK2_3
{SPR_RDMN,20,4,NULL,S_RDMN_DAMAGED_PAIN2,0,0},	// S_RDMN_DAMAGED_PAIN1
{SPR_RDMN,20,4,A_Pain,S_RDMN_DAMAGED_CHASE1,0,0},	// S_RDMN_DAMAGED_PAIN2
// End damaged states
{SPR_RDMN,7,6,NULL,S_RDMN_DEATH2,0,0},	// S_RDMN_DEATH1
{SPR_RDMN,8,6,NULL,S_RDMN_DEATH3,0,0},	// S_RDMN_DEATH2
{SPR_RDMN,9,6,A_Scream,S_RDMN_DEATH4,0,0},	// S_RDMN_DEATH3
{SPR_RDMN,10,6,A_NoBlocking,S_RDMN_DEATH5,0,0},	// S_RDMN_DEATH4
{SPR_RDMN,11,6,A_QueueCorpse,S_RDMN_DEATH6,0,0},	// S_RDMN_DEATH5
{SPR_RDMN,12,6,NULL,S_RDMN_DEATH7,0,0},	// S_RDMN_DEATH6
{SPR_RDMN,13,6,NULL,S_RDMN_DEATH8,0,0},	// S_RDMN_DEATH7
{SPR_RDMN,14,6,NULL,S_RDMN_DEATH9,0,0},	// S_RDMN_DEATH8
{SPR_RDMN,15,-1,NULL,S_NULL,0,0},	// S_RDMN_DEATH9
{SPR_RDMN,7,6,NULL,S_RDMN_XDEATH2,0,0},	// S_RDMN_XDEATH1
{SPR_RDMN,8,6,A_Demon3Death,S_RDMN_XDEATH3,0,0},	// S_RDMN_XDEATH2
{SPR_RDMN,9,6,A_Scream,S_RDMN_XDEATH4,0,0},	// S_RDMN_XDEATH3
{SPR_RDMN,10,6,A_NoBlocking,S_RDMN_XDEATH5,0,0},	// S_RDMN_XDEATH4
{SPR_RDMN,11,6,A_QueueCorpse,S_RDMN_XDEATH6,0,0},	// S_RDMN_XDEATH5
{SPR_RDMN,12,6,NULL,S_RDMN_XDEATH7,0,0},	// S_RDMN_XDEATH6
{SPR_RDMN,13,6,NULL,S_RDMN_XDEATH8,0,0},	// S_RDMN_XDEATH7
{SPR_RDMN,14,6,NULL,S_RDMN_XDEATH9,0,0},	// S_RDMN_XDEATH8
{SPR_RDMN,15,-1,NULL,S_NULL,0,0},	// S_RDMN_XDEATH9
{SPR_DEMN,24,5,A_FreezeDeath,S_RDMN_ICE2,0,0},	// S_RDMN_ICE
{SPR_DEMN,24,1,A_FreezeDeathChunks,S_RDMN_ICE2,0,0},	// S_RDMN_ICE2
{SPR_RDMA,0,4,NULL,S_DEMON3CHUNK1_2,0,0},	// S_DEMON3CHUNK1_1
{SPR_RDMA,0,10,A_QueueCorpse,S_DEMON3CHUNK1_3,0,0},	// S_DEMON3CHUNK1_2
{SPR_RDMA,0,20,NULL,S_DEMON3CHUNK1_3,0,0},	// S_DEMON3CHUNK1_3
{SPR_RDMA,0,-1,NULL,S_NULL,0,0},	// S_DEMON3CHUNK1_4
{SPR_RDMB,0,4,NULL,S_DEMON3CHUNK2_2,0,0},	// S_DEMON3CHUNK2_1
{SPR_RDMB,0,10,A_QueueCorpse,S_DEMON3CHUNK2_3,0,0},	// S_DEMON3CHUNK2_2
{SPR_RDMB,0,20,NULL,S_DEMON3CHUNK2_3,0,0},	// S_DEMON3CHUNK2_3
{SPR_RDMB,0,-1,NULL,S_NULL,0,0},	// S_DEMON3CHUNK2_4
{SPR_RDMC,0,4,NULL,S_DEMON3CHUNK3_2,0,0},	// S_DEMON3CHUNK3_1
{SPR_RDMC,0,10,A_QueueCorpse,S_DEMON3CHUNK3_3,0,0},	// S_DEMON3CHUNK3_2
{SPR_RDMC,0,20,NULL,S_DEMON3CHUNK3_3,0,0},	// S_DEMON3CHUNK3_3
{SPR_RDMC,0,-1,NULL,S_NULL,0,0},	// S_DEMON3CHUNK3_4
{SPR_RDMD,0,4,NULL,S_DEMON3CHUNK4_2,0,0},	// S_DEMON3CHUNK4_1
{SPR_RDMD,0,10,A_QueueCorpse,S_DEMON3CHUNK4_3,0,0},	// S_DEMON3CHUNK4_2
{SPR_RDMD,0,20,NULL,S_DEMON3CHUNK4_3,0,0},	// S_DEMON3CHUNK4_3
{SPR_RDMD,0,-1,NULL,S_NULL,0,0},	// S_DEMON3CHUNK4_4
{SPR_RDME,0,4,NULL,S_DEMON3CHUNK5_2,0,0},	// S_DEMON3CHUNK5_1
{SPR_RDME,0,10,A_QueueCorpse,S_DEMON3CHUNK5_3,0,0},	// S_DEMON3CHUNK5_2
{SPR_RDME,0,20,NULL,S_DEMON3CHUNK5_3,0,0},	// S_DEMON3CHUNK5_3
{SPR_RDME,0,-1,NULL,S_NULL,0,0},	// S_DEMON3CHUNK5_4
{SPR_RDFX,32768,4,NULL,S_DEMON3FX_MOVE2,0,0},	// S_DEMON3FX_MOVE1
{SPR_RDFX,32769,4,NULL,S_DEMON3FX_MOVE3,0,0},	// S_DEMON3FX_MOVE2
{SPR_RDFX,32770,4,NULL,S_DEMON3FX_MOVE1,0,0},	// S_DEMON3FX_MOVE3
{SPR_DMFX,32771,4,NULL,S_DEMON3FX_BOOM2,0,0},	// S_DEMON3FX_BOOM1
{SPR_DMFX,32772,4,NULL,S_DEMON3FX_BOOM3,0,0},	// S_DEMON3FX_BOOM2
{SPR_DMFX,32773,3,NULL,S_DEMON3FX_BOOM4,0,0},	// S_DEMON3FX_BOOM3
{SPR_DMFX,32774,3,NULL,S_DEMON3FX_BOOM5,0,0},	// S_DEMON3FX_BOOM4
{SPR_DMFX,32775,3,NULL,S_NULL,0,0},	// S_DEMON3FX_BOOM5
//Stone Centaur
{SPR_SCNT,0,10,A_Look,S_SCENTAUR_LOOK2,0,0},	// S_SCENTAUR_LOOK1
{SPR_SCNT,1,10,A_Look,S_SCENTAUR_LOOK1,0,0},	// S_SCENTAUR_LOOK2
{SPR_SCNT,0,4,A_Chase,S_SCENTAUR_WALK2,0,0},	// S_SCENTAUR_WALK1
{SPR_SCNT,1,4,A_Chase,S_SCENTAUR_WALK3,0,0},	// S_SCENTAUR_WALK2
{SPR_SCNT,2,4,A_Chase,S_SCENTAUR_WALK4,0,0},	// S_SCENTAUR_WALK3
{SPR_SCNT,3,4,A_Chase,S_SCENTAUR_WALK1,0,0},	// S_SCENTAUR_WALK4
{SPR_SCNT,7,5,A_FaceTarget,S_SCENTAUR_ATK2,0,0},	// S_SCENTAUR_ATK1
{SPR_SCNT,8,4,A_FaceTarget,S_SCENTAUR_ATK3,0,0},	// S_SCENTAUR_ATK2
{SPR_SCNT,9,7,A_SCentaurAttack,S_SCENTAUR_WALK1,0,0},	// S_SCENTAUR_ATK3
{SPR_SCNT,4,10,A_FaceTarget,S_SCENTAUR_MISSILE2,0,0},	// S_SCENTAUR_MISSILE1
{SPR_SCNT,32773,8,A_SCentaurAttack2,S_SCENTAUR_MISSILE3,0,0},	// S_SCENTAUR_MISSILE2
{SPR_SCNT,4,10,A_FaceTarget,S_SCENTAUR_MISSILE4,0,0},	// S_SCENTAUR_MISSILE3
{SPR_SCNT,32773,8,A_SCentaurAttack2,S_SCENTAUR_WALK1,0,0},	// S_SCENTAUR_MISSILE4
{SPR_SCNT,6,6,A_Pain,S_SCENTAUR_PAIN2,0,0},	// S_SCENTAUR_PAIN1
{SPR_SCNT,6,6,A_SetReflective,S_SCENTAUR_PAIN3,0,0},	// S_SCENTAUR_PAIN2
{SPR_SCNT,4,15,A_CentaurDefend,S_SCENTAUR_PAIN4,0,0},	// S_SCENTAUR_PAIN3
{SPR_SCNT,4,15,A_CentaurDefend,S_SCENTAUR_PAIN5,0,0},	// S_SCENTAUR_PAIN4
{SPR_SCNT,4,15,A_CentaurDefend,S_SCENTAUR_PAIN6,0,0},	// S_SCENTAUR_PAIN5
{SPR_SCNT,4,1,A_UnSetReflective,S_SCENTAUR_WALK1,0,0},	// S_SCENTAUR_PAIN6
// Start damaged states
/*{SPR_CEND,0,10,A_Look,S_CENTAUR_DAMAGED_LOOK2,0,0},	// S_CENTAUR_DAMAGED_LOOK1
{SPR_CEND,1,10,A_Look,S_CENTAUR_DAMAGED_LOOK1,0,0},	// S_CENTAUR_DAMAGED_LOOK2
{SPR_CEND,0,4,A_Chase,S_CENTAUR_DAMAGED_WALK2,0,0},	// S_CENTAUR_DAMAGED_WALK1
...
{SPR_CEND,7,5,A_FaceTarget,S_CENTAUR_DAMAGED_ATK2,0,0},	// S_CENTAUR_DAMAGED_ATK1
{SPR_CEND,8,4,A_FaceTarget,S_CENTAUR_DAMAGED_ATK3,0,0},	// S_CENTAUR_DAMAGED_ATK2
{SPR_CEND,9,7,A_SCentaurAttack,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_ATK3
{SPR_CEND,4,10,A_FaceTarget,S_CENTAUR_DAMAGED_MISSILE2,0,0},	// S_CENTAUR_DAMAGED_MISSILE1
{SPR_CEND,5|FF_FULLBRIGHT,8,A_SCentaurAttack2,S_CENTAUR_DAMAGED_MISSILE3,0,0},	// S_CENTAUR_DAMAGED_MISSILE2
{SPR_CEND,4,10,A_FaceTarget,S_CENTAUR_DAMAGED_MISSILE4,0,0},	// S_CENTAUR_DAMAGED_MISSILE3
{SPR_CEND,5|FF_FULLBRIGHT,8,A_SCentaurAttack2,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_MISSILE4
{SPR_CEND,6,6,A_Pain,S_CENTAUR_DAMAGED_PAIN2,0,0},	// S_CENTAUR_DAMAGED_PAIN1
{SPR_CEND,6,6,A_SetReflective,S_CENTAUR_DAMAGED_PAIN3,0,0},	// S_CENTAUR_DAMAGED_PAIN2
{SPR_CEND,4,15,A_CentaurDefend,S_CENTAUR_DAMAGED_PAIN4,0,0},	// S_CENTAUR_DAMAGED_PAIN3
{SPR_CEND,4,15,A_CentaurDefend,S_CENTAUR_DAMAGED_PAIN5,0,0},	// S_CENTAUR_DAMAGED_PAIN4
...
{SPR_CEND,4,1,A_UnSetReflective,S_CENTAUR_DAMAGED_WALK1,0,0},	// S_CENTAUR_DAMAGED_PAIN6*/
// End damaged states
{SPR_SCNT,0,1,A_SCentaurDie,S_NULL,0,0},	// S_CENTAUR_DEATH
{SPR_CENT,20,5,A_FreezeDeath,S_SCENTAUR_ICE2,0,0},	// S_CENTAUR_ICE
{SPR_CENT,20,1,A_FreezeDeathChunks,S_SCENTAUR_ICE2,0,0},	// S_CENTAUR_ICE2
{SPR_CTFX,32768,-1,NULL,S_NULL,0,0},	// S_CENTAUR_FX1
{SPR_CTFX,32769,4,NULL,S_SCENTAUR_FX_X2,0,0},	// S_CENTAUR_FX_X1
{SPR_CTFX,32770,3,NULL,S_SCENTAUR_FX_X3,0,0},	// S_CENTAUR_FX_X2
{SPR_CTFX,32771,4,NULL,S_SCENTAUR_FX_X4,0,0},	// S_CENTAUR_FX_X3
{SPR_CTFX,32772,3,NULL,S_SCENTAUR_FX_X5,0,0},	// S_CENTAUR_FX_X4
{SPR_CTFX,32773,2,NULL,S_NULL,0,0},	// S_CENTAUR_FX_X5
{SPR_SCSS,0,3,A_CheckFloor,S_SCENTAUR_SHIELD2,0,0},	// S_CENTAUR_SHIELD1
{SPR_SCSS,1,3,A_CheckFloor,S_SCENTAUR_SHIELD3,0,0},	// S_CENTAUR_SHIELD2
{SPR_SCSS,2,3,A_CheckFloor,S_SCENTAUR_SHIELD4,0,0},	// S_CENTAUR_SHIELD3
{SPR_SCSS,3,3,A_CheckFloor,S_SCENTAUR_SHIELD5,0,0},	// S_CENTAUR_SHIELD4
{SPR_SCSS,4,3,A_CheckFloor,S_SCENTAUR_SHIELD6,0,0},	// S_CENTAUR_SHIELD5
{SPR_SCSS,5,3,A_CheckFloor,S_SCENTAUR_SHIELD3,0,0},	// S_CENTAUR_SHIELD6
{SPR_SCSS,6,4,NULL,S_SCENTAUR_SHIELD_X2,0,0},	// S_CENTAUR_SHIELD_X1
{SPR_SCSS,7,4,A_QueueCorpse,S_SCENTAUR_SHIELD_X3,0,0},	// S_CENTAUR_SHIELD_X2
{SPR_SCSS,8,4,NULL,S_SCENTAUR_SHIELD_X4,0,0},	// S_CENTAUR_SHIELD_X3
{SPR_SCSS,9,-1,NULL,S_NULL,0,0},	// S_CENTAUR_SHIELD_X4
{SPR_SCSS,10,3,A_CheckFloor,S_SCENTAUR_SWORD2,0,0},	// S_CENTAUR_SWORD1
{SPR_SCSS,11,3,A_CheckFloor,S_SCENTAUR_SWORD3,0,0},	// S_CENTAUR_SWORD2
{SPR_SCSS,12,3,A_CheckFloor,S_SCENTAUR_SWORD4,0,0},	// S_CENTAUR_SWORD3
{SPR_SCSS,13,3,A_CheckFloor,S_SCENTAUR_SWORD5,0,0},	// S_CENTAUR_SWORD4
{SPR_SCSS,14,3,A_CheckFloor,S_SCENTAUR_SWORD6,0,0},	// S_CENTAUR_SWORD5
{SPR_SCSS,15,3,A_CheckFloor,S_SCENTAUR_SWORD7,0,0},	// S_CENTAUR_SWORD6
{SPR_SCSS,16,3,A_CheckFloor,S_SCENTAUR_SWORD3,0,0},	// S_CENTAUR_SWORD7
{SPR_SCSS,17,4,NULL,S_SCENTAUR_SWORD_X2,0,0},	// S_CENTAUR_SWORD_X1
{SPR_SCSS,18,4,A_QueueCorpse,S_SCENTAUR_SWORD_X3,0,0},	// S_CENTAUR_SWORD_X2
{SPR_SCSS,19,-1,NULL,S_NULL,0,0},	// S_CENTAUR_SWORD_X3
// Stone Chunks
{SPR_STNC,0,10,NULL,S_STONECHUNK2,0,0},	// S_STONECHUNK
{SPR_STNC,0,10,A_IceCheckHeadDone,S_STONECHUNK_HEAD,0,0},	// S_STONECHUNK_HEAD
{SPR_STNC,0,1050,NULL,S_NULL,0,0},	// S_STONECHUNK_HEAD2
// Stone Wendigo
{SPR_ROCY,0,10,A_Look,S_STONEGUY_LOOK,0,0},	// S_ICEGUY_LOOK
{SPR_ROCY,0,-1,NULL,S_STONEGUY_LOOK,0,0},	// S_ICEGUY_DORMANT
{SPR_ROCY,0,4,A_Chase,S_STONEGUY_WALK2,0,0},	// S_ICEGUY_WALK1
{SPR_ROCY,1,4,A_Chase,S_STONEGUY_WALK3,0,0},	// S_ICEGUY_WALK2
{SPR_ROCY,2,4,A_Chase,S_STONEGUY_WALK4,0,0},	// S_ICEGUY_WALK3
{SPR_ROCY,3,4,A_Chase,S_STONEGUY_WALK1,0,0},	// S_ICEGUY_WALK4
{SPR_ROCY,4,3,A_FaceTarget,S_STONEGUY_ATK2,0,0},	// S_ICEGUY_ATK1
{SPR_ROCY,5,3,A_FaceTarget,S_STONEGUY_ATK3,0,0},	// S_ICEGUY_ATK2
{SPR_ROCY,32774,8,A_StoneGuyAttack,S_STONEGUY_ATK4,0,0},	// S_ICEGUY_ATK3
{SPR_ROCY,5,4,A_FaceTarget,S_STONEGUY_WALK1,0,0},	// S_ICEGUY_ATK4
{SPR_ROCY,0,1,A_Pain,S_STONEGUY_WALK1,0,0},	// S_ICEGUY_PAIN1
{SPR_ROCY,0,1,A_StoneGuyDie,S_NULL,0,0},	// S_ICEGUY_DEATH
{SPR_STPR,32768,3,A_StoneGuyMissilePuff,S_STONEGUY_FX2,0,0},	// S_ICEGUY_FX1
{SPR_STPR,32769,3,A_StoneGuyMissilePuff,S_STONEGUY_FX3,0,0},	// S_ICEGUY_FX2
{SPR_STPR,32770,3,A_StoneGuyMissilePuff,S_STONEGUY_FX1,0,0},	// S_ICEGUY_FX3
{SPR_STPR,32771,4,NULL,S_STONEGUY_FX_X2,0,0},	// S_ICEGUY_FX_X1
{SPR_STPR,32772,4,A_StoneGuyMissileExplode,S_STONEGUY_FX_X3,0,0},	// S_ICEGUY_FX_X2
{SPR_STPR,32773,4,NULL,S_STONEGUY_FX_X4,0,0},	// S_ICEGUY_FX_X3
{SPR_STPR,32774,4,NULL,S_STONEGUY_FX_X5,0,0},	// S_ICEGUY_FX_X4
{SPR_STPR,32775,3,NULL,S_NULL,0,0},	// S_ICEGUY_FX_X5
{SPR_STPR,8,3,NULL,S_STONEFX_PUFF2,0,0},	// S_ICEFX_PUFF1
{SPR_STPR,9,3,NULL,S_STONEFX_PUFF3,0,0},	// S_ICEFX_PUFF2
{SPR_STPR,10,3,NULL,S_STONEFX_PUFF4,0,0},	// S_ICEFX_PUFF3
{SPR_STPR,11,2,NULL,S_STONEFX_PUFF5,0,0},	// S_ICEFX_PUFF4
{SPR_STPR,12,2,NULL,S_NULL,0,0},	// S_ICEFX_PUFF5
{SPR_STPR,32781,3,NULL,S_STONEGUY_FX2_2,0,0},	// S_ICEGUY_FX2_1
{SPR_STPR,32782,3,NULL,S_STONEGUY_FX2_3,0,0},	// S_ICEGUY_FX2_2
{SPR_STPR,32783,3,NULL,S_STONEGUY_FX2_1,0,0},	// S_ICEGUY_FX2_3
{SPR_STPR,32784,50,NULL,S_NULL,0,0},	// S_ICEGUY_BIT1
{SPR_STPR,32785,50,NULL,S_NULL,0,0},	// S_ICEGUY_BIT2
// Shadow Thingie
{SPR_SHDW,0,10,A_Look,S_BEAST_LOOK2,0,0},	// S_BEAST_LOOK1
{SPR_SHDW,1,10,A_Look,S_BEAST_LOOK1,0,0},	// S_BEAST_LOOK2
{SPR_SHDW,0,3,A_Chase,S_BEAST_WALK2,0,0},	// S_BEAST_WALK1
{SPR_SHDW,1,3,A_Chase,S_BEAST_WALK3,0,0},	// S_BEAST_WALK2
{SPR_SHDW,2,3,A_Chase,S_BEAST_WALK4,0,0},	// S_BEAST_WALK3
{SPR_SHDW,3,3,A_Chase,S_BEAST_WALK5,0,0},	// S_BEAST_WALK4
{SPR_SHDW,4,3,A_Chase,S_BEAST_WALK6,0,0},	// S_BEAST_WALK5
{SPR_SHDW,5,3,A_Chase,S_BEAST_WALK1,0,0},	// S_BEAST_WALK6
{SPR_SHDW,7,10,A_FaceTarget,S_BEAST_ATK2,0,0},	// S_BEAST_ATK1
{SPR_SHDW,8,10,A_BeastAttack,S_BEAST_WALK1,0,0},	// S_BEAST_ATK2
{SPR_SHDW,6,3,NULL,S_BEAST_PAIN2,0,0},	// S_BEAST_PAIN1
{SPR_SHDW,6,3,A_Pain,S_BEAST_WALK1,0,0},	// S_BEAST_PAIN2
{SPR_SHDW,17,6,NULL,S_BEAST_DIE2,0,0},	// S_BEAST_DIE1
{SPR_SHDW,18,6,A_Scream,S_BEAST_DIE3,0,0},	// S_BEAST_DIE2
{SPR_SHDW,19,6,NULL,S_BEAST_DIE4,0,0},	// S_BEAST_DIE3
{SPR_SHDW,20,6,NULL,S_BEAST_DIE5,0,0},	// S_BEAST_DIE4
{SPR_SHDW,21,6,NULL,S_BEAST_DIE6,0,0},	// S_BEAST_DIE5
{SPR_SHDW,22,6,A_NoBlocking,S_BEAST_DIE7,0,0},	// S_BEAST_DIE6
{SPR_SHDW,23,6,NULL,S_BEAST_DIE8,0,0},	// S_BEAST_DIE7
{SPR_SHDW,24,6,NULL,S_BEAST_DIE9,0,0},	// S_BEAST_DIE8
{SPR_SHDW,25,-1,NULL,S_NULL,0,0},	// S_BEAST_DIE9
{SPR_SHDW,9,5,NULL,S_BEAST_XDIE2,0,0},	// S_BEAST_XDIE1
{SPR_SHDW,10,6,A_Scream,S_BEAST_XDIE3,0,0},	// S_BEAST_XDIE2
{SPR_SHDW,11,5,NULL,S_BEAST_XDIE4,0,0},	// S_BEAST_XDIE3
{SPR_SHDW,12,6,NULL,S_BEAST_XDIE5,0,0},	// S_BEAST_XDIE4
{SPR_SHDW,13,5,NULL,S_BEAST_XDIE6,0,0},	// S_BEAST_XDIE5
{SPR_SHDW,14,6,A_NoBlocking,S_BEAST_XDIE7,0,0},	// S_BEAST_XDIE6
{SPR_SHDW,15,5,NULL,S_BEAST_XDIE8,0,0},	// S_BEAST_XDIE7
{SPR_SHDW,16,-1,NULL,S_NULL,0,0},	// S_BEAST_XDIE8
{SPR_SHDX,0,2,A_BeastPuff,S_BEASTBALL2,0,0},	// S_BEASTBALL1
{SPR_SHDX,0,2,A_BeastPuff,S_BEASTBALL3,0,0},	// S_BEASTBALL2
{SPR_SHDX,1,2,A_BeastPuff,S_BEASTBALL4,0,0},	// S_BEASTBALL3
{SPR_SHDX,1,2,A_BeastPuff,S_BEASTBALL5,0,0},	// S_BEASTBALL4
{SPR_SHDX,2,2,A_BeastPuff,S_BEASTBALL6,0,0},	// S_BEASTBALL5
{SPR_SHDX,2,2,A_BeastPuff,S_BEASTBALL1,0,0},	// S_BEASTBALL6
{SPR_SHDX,3,4,NULL,S_BEASTBALLX2,0,0},	// S_BEASTBALLX1
{SPR_SHDX,4,4,NULL,S_BEASTBALLX3,0,0},	// S_BEASTBALLX2
{SPR_SHDX,5,4,NULL,S_BEASTBALLX4,0,0},	// S_BEASTBALLX3
{SPR_SHDX,6,4,NULL,S_BEASTBALLX5,0,0},	// S_BEASTBALLX4
{SPR_SHDX,7,4,NULL,S_NULL,0,0},	// S_BEASTBALLX5
{SPR_SHDX,0,4,NULL,S_BURNBALL2,0,0},	// S_BURNBALL1
{SPR_SHDX,1,4,NULL,S_BURNBALL3,0,0},	// S_BURNBALL2
{SPR_SHDX,2,4,NULL,S_BURNBALL4,0,0},	// S_BURNBALL3
{SPR_SHDX,3,4,NULL,S_BURNBALL5,0,0},	// S_BURNBALL4
{SPR_SHDX,4,4,NULL,S_BURNBALL6,0,0},	// S_BURNBALL5
{SPR_SHDX,5,4,NULL,S_BURNBALL7,0,0},	// S_BURNBALL6
{SPR_SHDX,6,4,NULL,S_BURNBALL8,0,0},	// S_BURNBALL7
{SPR_SHDX,7,4,NULL,S_NULL,0,0},	// S_BURNBALL8
{SPR_SHDX,32768,4,NULL,S_BURNBALLFB2,0,0},	// S_BURNBALLFB1
{SPR_SHDX,32769,4,NULL,S_BURNBALLFB3,0,0},	// S_BURNBALLFB2
{SPR_SHDX,32770,4,NULL,S_BURNBALLFB4,0,0},	// S_BURNBALLFB3
{SPR_SHDX,32771,4,NULL,S_BURNBALLFB5,0,0},	// S_BURNBALLFB4
{SPR_SHDX,32772,4,NULL,S_BURNBALLFB6,0,0},	// S_BURNBALLFB5
{SPR_SHDX,32773,4,NULL,S_BURNBALLFB7,0,0},	// S_BURNBALLFB6
{SPR_SHDX,32774,4,NULL,S_BURNBALLFB8,0,0},	// S_BURNBALLFB7
{SPR_SHDX,32775,4,NULL,S_NULL,0,0},	// S_BURNBALLFB8
{SPR_SHDX,3,4,NULL,S_PUFFY2,0,0},	// S_PUFFY1
{SPR_SHDX,4,4,NULL,S_PUFFY3,0,0},	// S_PUFFY2
{SPR_SHDX,5,4,NULL,S_PUFFY4,0,0},	// S_PUFFY3
{SPR_SHDX,6,4,NULL,S_PUFFY5,0,0},	// S_PUFFY4
{SPR_SHDX,7,4,NULL,S_NULL,0,0},	// S_PUFFY5
// Ice Wand
{SPR_BWND,0,1,A_WeaponReady,S_ICEWANDREADY,0,0},	// S_ICEWANDREADY
{SPR_BWND,0,1,A_Lower,S_ICEWANDDOWN,0,0},	// S_ICEWANDDOWN
{SPR_BWND,0,1,A_Raise,S_ICEWANDUP,0,0},	// S_ICEWANDUP
{SPR_BWND,1,3,NULL,S_ICEWANDATK1_2,0,0},	// S_ICEWANDATK1_1
{SPR_BWND,2,5,A_FireIceWand,S_ICEWANDATK1_3,0,0},	// S_ICEWANDATK1_2
{SPR_BWND,3,3,NULL,S_ICEWANDATK1_4,0,0},	// S_ICEWANDATK1_3
{SPR_BWND,3,0,A_ReFire,S_ICEWANDREADY,0,0},	// S_ICEWANDATK1_4
{SPR_BSRD,32768,2,NULL,S_BWANDFX1_2,0,0},	// S_BWANDFX1_1
{SPR_BSRD,32768,3,NULL,S_BWANDFX1_3,0,0},	// S_BWANDFX1_2
{SPR_BSRD,32769,3,NULL,S_BWANDFX1_4,0,0},	// S_BWANDFX1_3
{SPR_BSRD,32770,3,NULL,S_BWANDFX1_1,0,0},	// S_BWANDFX1_4
{SPR_BSEX,32768,5,NULL,S_BWANDFXE1_2,0,0},	// S_BWANDFXE1_1
{SPR_BSEX,32769,5,NULL,S_BWANDFXE1_3,0,0},	// S_BWANDFXE1_2
{SPR_BSEX,32770,5,NULL,S_BWANDFXE1_4,0,0},	// S_BWANDFXE1_3
{SPR_BSEX,32771,5,NULL,S_BWANDFXE1_5,0,0},	// S_BWANDFXE1_4
{SPR_BSEX,32772,5,NULL,S_NULL,0,0},	// S_BWANDFXE1_5
// Hammer 2
{SPR_FHM2,0,1,A_WeaponReady,S_FHAM2READY_2,0,0},	// S_FHAMMERREADY_1
{SPR_FHM2,0,1,A_WeaponReady,S_FHAM2READY_3,0,0},	// S_FHAMMERREADY_2
{SPR_FHM2,0,1,A_WeaponReady,S_FHAM2READY_4,0,0},	// S_FHAMMERREADY_3
{SPR_FHM2,0,1,A_WeaponReady,S_FHAM2READY_5,0,0},	// S_FHAMMERREADY_4
{SPR_FHM2,1,1,A_WeaponReady,S_FHAM2READY_6,0,0},	// S_FHAMMERREADY_5
{SPR_FHM2,1,1,A_WeaponReady,S_FHAM2READY_7,0,0},	// S_FHAMMERREADY_6
{SPR_FHM2,1,1,A_WeaponReady,S_FHAM2READY_8,0,0},	// S_FHAMMERREADY_7
{SPR_FHM2,1,1,A_WeaponReady,S_FHAM2READY_9,0,0},	// S_FHAMMERREADY_8
{SPR_FHM2,2,1,A_WeaponReady,S_FHAM2READY_10,0,0},	// S_FHAMMERREADY_9
{SPR_FHM2,2,1,A_WeaponReady,S_FHAM2READY_11,0,0},	// S_FHAMMERREADY_10
{SPR_FHM2,2,1,A_WeaponReady,S_FHAM2READY_12,0,0},	// S_FHAMMERREADY_11
{SPR_FHM2,2,1,A_WeaponReady,S_FHAM2READY_1,0,0},	// S_FHAMMERREADY_12
{SPR_FHM2,0,1,A_Lower,S_FHAM2DOWN,0,0},	// S_FHAMMERDOWN
{SPR_FHM2,0,1,A_Raise,S_FHAM2UP,0,0},	// S_FHAMMERUP
{SPR_FHM2,3,6,NULL,S_FHAM2ATK_2,5,0},	// S_FHAMMERATK_1
{SPR_FHM2,4,3,A_FHammerAttack,S_FHAM2ATK_3,5,0},	// S_FHAMMERATK_2
{SPR_FHM2,5,3,NULL,S_FHAM2ATK_4,5,0},	// S_FHAMMERATK_3
{SPR_FHM2,6,2,NULL,S_FHAM2ATK_5,5,0},	// S_FHAMMERATK_4
{SPR_FHM2,6,10,A_FHammerThrow,S_FHAM2ATK_6,5,150},	// S_FHAMMERATK_5
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_7,0,60},	// S_FHAMMERATK_6
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_8,0,55},	// S_FHAMMERATK_7
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_9,0,50},	// S_FHAMMERATK_8
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_10,0,45},	// S_FHAMMERATK_9
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_11,0,40},	// S_FHAMMERATK_10
{SPR_FHM2,0,1,NULL,S_FHAM2ATK_12,0,35},	// S_FHAMMERATK_11
{SPR_FHM2,0,1,NULL,S_FHAM2READY_1,0,0},	// S_FHAMMERATK_12
// Helmetless cleric
{SPR_CLHL,0,4,A_NPCStand,S_HLCLER,0,0},	// S_HLCLER
{SPR_CLHL,0,4,A_NPCWalk,S_HLCLER_WALK2,0,0},	// S_HLCLER_WALK1
{SPR_CLHL,0,4,A_NPCWalk,S_HLCLER_WALK3,0,0},	// S_HLCLER_WALK2
{SPR_CLHL,1,4,A_NPCWalk,S_HLCLER_WALK4,0,0},	// S_HLCLER_WALK3
{SPR_CLHL,1,4,A_NPCWalk,S_HLCLER_WALK5,0,0},	// S_HLCLER_WALK4
{SPR_CLHL,2,4,A_NPCWalk,S_HLCLER_WALK6,0,0},	// S_HLCLER_WALK5
{SPR_CLHL,2,4,A_NPCWalk,S_HLCLER_WALK7,0,0},	// S_HLCLER_WALK6
{SPR_CLHL,3,4,A_NPCWalk,S_HLCLER_WALK8,0,0},	// S_HLCLER_WALK7
{SPR_CLHL,3,4,A_NPCWalk,S_HLCLER_WALK1,0,0},	// S_HLCLER_WALK8
// New NPCs
{SPR_LELE,0,-1,NULL,S_NULL,0,0},		// S_LEGIONLEAD
{SPR_PEAS,0,-1,NULL,S_NULL,0,0},		// S_PEASENT
{SPR_WOM1,0,-1,NULL,S_NULL,0,0},		// S_WOMAN1
{SPR_WOM2,0,-1,NULL,S_NULL,0,0},		// S_WOMAN2
{SPR_WOM3,0,-1,NULL,S_NULL,0,0},		// S_WOMAN3
{SPR_BLSM,0,-1,NULL,S_NULL,0,0},		// S_BLACKSMITH
{SPR_CHLE,0,-1,NULL,S_NULL,0,0},		// S_CHURCHLEADER
{SPR_ARLE,0,-1,NULL,S_NULL,0,0},		// S_ARCANUMLEADER
{SPR_PRST,0,-1,NULL,S_NULL,0,0},		// S_PRIEST
{SPR_SHO2,0,-1,NULL,S_NULL,0,0},		// S_SHOPKEEPER2
};
...
4,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF|MF_NOGRAVITY,		// flags
...
10001,		// damage
SFX_NONE,		// activesound
MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF|MF_NOGRAVITY|MF_NOBLOCKMAP,		// flags
MF2_NOTELEPORT		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOGRAVITY|MF_NOBLOCKMAP|MF_SHADOW|MF_NOCLIP|MF_DROPOFF|MF_VIEWALIGN,		// flags
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_VIEWALIGN|MF_NOGRAVITY|MF_SHADOW,		// flags
0		// flags2
 },
...
8,		// damage
SFX_NONE,		// activesound
MF_MISSILE|MF_BRIGHTEXPLODE|MF_NOBLOCKMAP|MF_NOGRAVITY|MF_DROPOFF,		// flags
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_NOGRAVITY|MF_VIEWALIGN|MF_SHADOW,		// flags
0		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_SPECIAL|MF_NOGRAVITY|MF_VIEWALIGN,		// flags
0		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_VIEWALIGN|MF_NOGRAVITY,		// flags
0		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_VIEWALIGN|MF_NOGRAVITY|MF_BRIGHTSHADOW,		// flags
0		// flags2
 },
...
2,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF|MF_NOGRAVITY|MF_BRIGHTSHADOW,		// flags
MF2_NOTELEPORT|MF2_FIREDAMAGE		// flags2
 },
...
3,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_NOGRAVITY|MF_BRIGHTSHADOW|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_NOGRAVITY|MF_VIEWALIGN|MF_NOCLIP|MF_ALTSHADOW,		// flags
MF2_NOTELEPORT		// flags2
 },
...
4,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_NOGRAVITY|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
MF2_NOTELEPORT		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_NOGRAVITY|MF_VIEWALIGN|MF_ALTSHADOW,		// flags
MF2_NOTELEPORT		// flags2
 },
...
8,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_NOGRAVITY|MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF,		// flags
MF2_NOTELEPORT|MF2_IMPACT|MF2_PCROSS		// flags2
 },
...
2,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_NOGRAVITY|MF_MISSILE|MF_BRIGHTEXPLODE|MF_VIEWALIGN|MF_DROPOFF,		// flags
0		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_ALTSHADOW,		// flags
...
115,		// doomednum
S_CENTAUR_LOOK1,		// spawnstate
600,		// spawnhealth //Remi: halved his health for KMOD2
S_CENTAUR_WALK1,		// seestate
SFX_CENTAUR_SIGHT,		// seesound
8,		// reactiontime
SFX_CENTAUR_ATTACK,		// attacksound
...
16*FRACUNIT,		// height
100,		// mass
8,		// damage //Remi: doubled his damage for KMOD2
SFX_NONE,		// activesound
MF_MISSILE|MF_BRIGHTEXPLODE|MF_NOBLOCKMAP|MF_NOGRAVITY|MF_DROPOFF,		// flags
MF2_NOTELEPORT|MF2_IMPACT|MF2_PCROSS		// flags2
 },
...
400,		// spawnhealth //Remi: Decreased his health with 100 for KMOD2
...
6*FRACUNIT,		// height
100,		// mass
10,		// damage //Remi: doubled his damage for KMOD2
SFX_NONE,		// activesound
MF_MISSILE|MF_BRIGHTEXPLODE|MF_NOBLOCKMAP|MF_NOGRAVITY|MF_DROPOFF,		// flags
MF2_NOTELEPORT|MF2_IMPACT|MF2_PCROSS|MF2_FIREDAMAGE		// flags2
 },
...
5,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_NOGRAVITY|MF_DROPOFF|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_DROPOFF|MF_NOGRAVITY|MF_ALTSHADOW|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
MF2_NOTELEPORT		// flags2
 },
...
16000,		// spawnhealth //Remi: Doubled for KMOD2
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_NOGRAVITY|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
MF2_NOTELEPORT|MF2_FLOORBOUNCE		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE,		// flags
MF2_NOTELEPORT|MF2_FLOORBOUNCE		// flags2
 },
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE|MF_NOGRAVITY,		// flags
MF2_NOTELEPORT		// flags2
 },
...
200000,		// spawnhealth //Remi: multiplied with 5 for KMOD2.01
...
// This is an addition of mine, originally intended for an external 
// camera. But until I get around to doing that, it's also used
// for 3D ambient sound positioning.
...
0,		// damage
SFX_NONE,		// activesound
MF_NOGRAVITY|MF_NOSECTOR|MF_NOBLOCKMAP|MF_TELEPORT|MF_DROPOFF,// flags
MF2_PASSMOBJ|MF2_SLIDE|MF2_CANNOTPUSH|MF2_DONTDRAW		// flags2*/

 },

//Added by the Korax Project
...
0,		// damage
SFX_NONE,		// activesound
MF_SOLID|MF_DROPOFF|MF_NOGRAVITY|MF_FLOAT,		// flags
MF2_SLIDE|MF2_TELESTOMP|MF2_PASSMOBJ		// flags2
 },

{		// MT_OBJECT2
12022,		// doomednum
S_OBJECT2,		// spawnstate
1000,		// spawnhealth
S_NULL,		// seestate
SFX_NONE,		// seesound
8,		// reactiontime
...
//Remi
{           		// MT_POSS_ETTIN - The Possessed Ettin
-1,          		// doomednum
S_POSS_ETTIN,		// spawnstate
175,	         	// spawnhealth
S_ETTIN_CHASE1,		// seestate
SFX_NONE,	    	// seesound
0,		            // reactiontime
SFX_NONE,	    	// attacksound
S_POSS_ETTIN_PAIN1, // painstate
255,		        // painchance
SFX_ETTIN_PAIN,		// painsound
S_NULL,		        // meleestate
S_POSS_ETTIN_ATK1_1,// missilestate
S_NULL,		        // crashstate
S_ETTIN_DEATH1_1,	// deathstate
S_ETTIN_DEATH2_1,	// xdeathstate
SFX_ETTIN_DEATH,	// deathsound
...
{           		// MT_POSS_AFRIT - Possessed Afrit
-1,		            // doomednum
S_POSS_FIRED,		// spawnstate
80,		            // spawnhealth
S_FIRED_WALK1,		// seestate
SFX_NONE,		    // seesound
8,		            // reactiontime
SFX_NONE,		    // attacksound
S_POSS_FIRED_PAIN1,	// painstate
255,		        // painchance
SFX_FIRED_PAIN,		// painsound
S_NULL,		        // meleestate
S_POSS_FIRED_ATTACK1,// missilestate
S_FIRED_XDEATH1,    // crashstate
S_FIRED_DEATH1,		// deathstate
S_FIRED_XDEATH1,	// xdeathstate
SFX_FIRED_DEATH,	// deathsound
...
SFX_FIRED_ACTIVE,   // activesound
MF_SOLID|MF_SHOOTABLE|MF_DROPOFF|MF_NOTDMATCH,		// flags
MF2_WINDTHRUST|MF2_SLIDE|MF2_PASSMOBJ|MF2_FLOORCLIP|MF2_TELESTOMP|MF2_PUSHWALL|MF2_FLY// flags2
 },
 {					// MT_POSS_CENTAUR - Possessed Centaur
-1,					// doomednum
S_POSS_CENTAUR,		// spawnstate
200,				// spawnhealth
S_CENTAUR_WALK1,	// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_CENTAUR_PAIN,// painstate
255,				// painchance
SFX_CENTAUR_PAIN,	// painsound
S_POSS_CENTAUR_ATK1,// meleestate
S_POSS_CENTAUR_MISSILE1,// missilestate
S_NULL,				// crashstate
S_CENTAUR_DEATH1,	// deathstate
S_CENTAUR_DEATH_X1,	// xdeathstate
SFX_CENTAUR_DEATH,	// deathsound
...
{					// MT_POSS_CENTAURL - Possessed Centaur Leader
-1,					// doomednum
S_POSS_CENTAUR,		// spawnstate
1200,				// spawnhealth
S_CENTAUR_WALK1,	// seestate
...
{					// MT_POSS_ICEGUY //Possessed Iceguy
-1,					// doomednum
S_POSS_ICEGUY,		// spawnstate
120,				// spawnhealth
S_ICEGUY_WALK1,		// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_ICEGUY_PAIN,	// painstate
255,				// painchance
SFX_NONE,			// painsound
S_NULL,				// meleestate
S_POSS_ICEGUY_ATK1,	// missilestate
S_NULL,				// crashstate
S_ICEGUY_DEATH,		// deathstate
S_NULL,				// xdeathstate
SFX_NONE,			// deathsound
...
0,					// damage
SFX_ICEGUY_ACTIVE,	// activesound
MF_SOLID|MF_SHOOTABLE|MF_DROPOFF|MF_NOTDMATCH|MF_NOBLOOD,		// flags
MF2_WINDTHRUST|MF2_SLIDE|MF2_PASSMOBJ|MF2_FLOORCLIP|MF2_TELESTOMP|MF2_PUSHWALL    // flags2
 },
{					// MT_POSS_DEMON //Possessed Serpent
-1,					// doomednum
S_POSS_DEMN,		// spawnstate
250,				// spawnhealth
S_DEMN_CHASE1,		// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_DEMN_PAIN,	// painstate
255,				// painchance
SFX_DEMON_PAIN,		// painsound
S_POSS_DEMN_ATK1_1,	// meleestate
S_NULL,				// missilestate
S_NULL,				// crashstate
S_DEMN_DEATH1,		// deathstate
S_DEMN_XDEATH1,		// xdeathstate
...
{					// MT_POSS_DEMON2 //Possessed Brown Serpent
-1,					// doomednum
S_POSS_DEMN2,		// spawnstate
500,				// spawnhealth
S_DEMN2_CHASE1,		// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_DEMN2_PAIN,	// painstate
255,				// painchance
SFX_DEMON_PAIN,		// painsound
S_POSS_DEMN2_ATK1_1,// meleestate
S_NULL,				// missilestate
S_NULL,				// crashstate
S_DEMN2_DEATH1,		// deathstate
S_DEMN2_XDEATH1,	// xdeathstate
...
{					// MT_POSS_WRAITH - Possessed Reiver
-1,					// doomednum
S_POSS_WRAITH_LOOK1,// spawnstate
800,				// spawnhealth
S_WRAITH_CHASE1,	// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_WRAITH_PAIN,	// painstate
255,				// painchance
SFX_WRAITH_PAIN,	// painsound
S_POSS_WRAITH_ATK1_1,// meleestate
S_NULL,				// missilestate
S_NULL,				// crashstate
S_WRAITH_DEATH1_1,	// deathstate
S_WRAITH_DEATH2_1,	// xdeathstate
...
{					// MT_POSS_BISHOP
-1,					// doomednum
S_POSS_BISHOP,		// spawnstate
666,				// spawnhealth
S_BISHOP_WALK1,		// seestate
SFX_NONE,			// seesound
8,					// reactiontime
SFX_NONE,			// attacksound
S_POSS_BISHOP_PAIN1,// painstate
255,				// painchance
SFX_BISHOP_PAIN,	// painsound
S_NULL,				// meleestate
S_POSS_BISHOP_ATK1,	// missilestate
S_NULL,				// crashstate
S_BISHOP_DEATH1,	// deathstate
S_NULL,				// xdeathstate
SFX_BISHOP_DEATH,	// deathsound
...
MF2_WINDTHRUST|MF2_SLIDE|MF2_PASSMOBJ|MF2_FLOORCLIP|MF2_TELESTOMP|MF2_PUSHWALL|MF2_FLY// flags2
 ...
 {					// MT_SERPENTPUFF - Melee sound/graphics
-1,					// doomednum
S_HAMMERPUFF1,		// spawnstate
1000,				// spawnhealth
S_NULL,				// seestate
SFX_DEMON_ATTACK,	// seesound
8,					// reactiontime
SFX_DEMON_ATTACK,	// attacksound
S_NULL,				// painstate
0,					// painchance
...
0		// flags2
 ...
 {					// MT_REIVERPUFF - Melee sound/graphics
-1,					// doomednum
S_HAMMERPUFF1,		// spawnstate
1000,				// spawnhealth
S_NULL,				// seestate
SFX_WRAITH_ATTACK,	// seesound
8,					// reactiontime
SFX_WRAITH_ATTACK,	// attacksound
S_NULL,				// painstate
0,					// painchance
...
0		// flags2
 ...
 {					// MT_BISHOPPUFF - Melee sound/graphics
-1,					// doomednum
S_HAMMERPUFF1,		// spawnstate
1000,				// spawnhealth
S_NULL,				// seestate
SFX_BISHOP_ATTACK,	// seesound
8,					// reactiontime
SFX_BISHOP_ATTACK,	// attacksound
S_NULL,				// painstate
0,					// painchance
...
0,					// damage
SFX_NONE,			// activesound
MF_SOLID|MF_SHOOTABLE|MF_DROPOFF|MF_PICKUP|MF_NOTDMATCH|MF_COUNTKILL,	// flags
MF2_WINDTHRUST|MF2_FLOORCLIP|MF2_SLIDE|MF2_PASSMOBJ|MF2_TELESTOMP|MF2_PUSHWALL		// flags2
 },
...
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF|MF_NOGRAVITY,		// flags
MF2_NOTELEPORT|MF2_RIP|MF2_FIREDAMAGE|MF2_IMPACT|MF2_PCROSS|MF2_NODMGTHRUST|MF2_CANNOTPUSH		// flags2
 },
{		// MT_MWAND4PUFF
-1,		// doomednum
S_MWAND4PUFF1,		// spawnstate
1000,		// spawnhealth
S_NULL,		// seestate
SFX_NONE,		// seesound
8,		// reactiontime
...
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_BRIGHTEXPLODE|MF_DROPOFF|MF_NOGRAVITY,		// flags
MF2_NOTELEPORT|MF2_IMPACT|MF2_PCROSS|MF2_NODMGTHRUST|MF2_CANNOTPUSH		// flags2
 },
 {		// MT_STAFFPUFF
-1,		// doomednum
...
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_BRIGHTEXPLODE,		// flags
MF2_FLOORBOUNCE|MF2_NOTELEPORT		// flags2
...
6,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_BRIGHTEXPLODE,		// flags
MF2_LOGRAV|MF2_FLOORBOUNCE|MF2_NOTELEPORT		// flags2
...
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_BRIGHTEXPLODE,		// flags
MF2_LOGRAV|MF2_FLOORBOUNCE|MF2_TELESTOMP		// flags2
...
0,		// damage
SFX_NONE,		// activesound
MF_NOBLOCKMAP|MF_BRIGHTSHADOW,		// flags
MF2_LOGRAV		// flags2
 },

{		// MT_SUMMONMONSTER
-1,		// doomednum
S_SUMMONMONSTER1,		// spawnstate
1000,		// spawnhealth
S_NULL,		// seestate
SFX_NONE,		// seesound
8,		// reactiontime
...
0,		// damage
SFX_NONE,		// activesound
MF_MISSILE|MF_DROPOFF|MF_NOBLOCKMAP|MF_NOSECTOR,		// flags
MF2_NOTELEPORT		// flags2
},
...
{		// MT_DEMON3
12035,		// doomednum
S_RDMN_LOOK1,		// spawnstate
250,		// spawnhealth
S_RDMN_CHASE1,		// seestate
SFX_DEMON_SIGHT,		// seesound
8,		// reactiontime
SFX_DEMON_ATTACK,		// attacksound
S_RDMN_PAIN1,		// painstate
50,		// painchance
SFX_DEMON_PAIN,		// painsound
S_RDMN_ATK1_1,		// meleestate
S_RDMN_ATK2_1,		// missilestate
S_NULL,		// crashstate
S_RDMN_DEATH1,		// deathstate
S_RDMN_XDEATH1,		// xdeathstate
SFX_DEMON_DEATH,		// deathsound
13,		// speed
32*FRACUNIT,		// radius
64*FRACUNIT,		// height
...
{		// MT_SCENTAUR
12036,		// doomednum
S_SCENTAUR_LOOK1,		// spawnstate
200,		// spawnhealth
S_SCENTAUR_WALK1,		// seestate
SFX_CENTAUR_SIGHT,		// seesound
8,		// reactiontime
SFX_CENTAUR_ATTACK,		// attacksound
S_SCENTAUR_PAIN1,		// painstate
135,		// painchance
SFX_CENTAUR_PAIN,		// painsound
S_SCENTAUR_ATK1,		// meleestate
0,		// missilestate
S_NULL,		// crashstate
S_SCENTAUR_DEATH,		// deathstate
S_NULL,		// xdeathstate
SFX_NONE,		// deathsound
13,		// speed
20*FRACUNIT,		// radius
...
SFX_CENTAUR_PAIN,		// painsound
S_SCENTAUR_ATK1,		// meleestate
S_SCENTAUR_MISSILE1,		// missilestate
S_NULL,		// crashstate
S_SCENTAUR_DEATH,		// deathstate
S_NULL,		// xdeathstate
SFX_NONE,		// deathsound
...
S_NULL,		// missilestate
S_NULL,		// crashstate
S_SCENTAUR_SHIELD_X1,		// deathstate
S_NULL,		// xdeathstate
SFX_NONE,		// deathsound
0,		// speed
20*FRACUNIT,		// radius
...
S_NULL,		// missilestate
S_NULL,		// crashstate
S_SCENTAUR_SWORD_X1,		// deathstate
S_NULL,		// xdeathstate
SFX_NONE,		// deathsound
0,		// speed
20*FRACUNIT,		// radius
...
{		// MT_STONEGUY
12038,		// doomednum
S_STONEGUY_LOOK,		// spawnstate
120,		// spawnhealth
S_STONEGUY_WALK1,		// seestate
SFX_ICEGUY_SIGHT,		// seesound
8,		// reactiontime
SFX_ICEGUY_ATTACK,		// attacksound
S_STONEGUY_PAIN1,		// painstate
144,		// painchance
SFX_NONE,		// painsound
0,		// meleestate
S_STONEGUY_ATK1,		// missilestate
S_NULL,		// crashstate
S_STONEGUY_DEATH,		// deathstate
S_NULL,		// xdeathstate
SFX_NONE,		// deathsound
14,		// speed
22*FRACUNIT,		// radius
