...
extern int borderUpd;
extern int clipLights, litSprites;
...
void UpdateEngineState()
{
	...
	H2_UpdateState(DD_PRE);
	R_Update();
	DD_ValidateLevel();
	H2_UpdateState(DD_POST);
