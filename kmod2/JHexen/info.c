...
void A_BatSpawn ();
void A_BatMove ();
void A_ProjFire (); //Remi
void A_DontMove ();
void A_MoveAgain ();
void A_PSetReflective ();
void A_PUnSetReflective ();
void A_PossBishWeapCheck ();
void A_PossBishStart ();
...
void A_BoltSpark();
void A_PossProjSpawn();
void A_SummonMonster();
