...
{
/*	Sky1Texture = 0;//P_GetMapSky1Texture(map);
	Sky2Texture = 0;//P_GetMapSky2Texture(map);
//	Sky1ScrollDelta = 0;//P_GetMapSky1ScrollDelta(map);
//	Sky2ScrollDelta = 0;//P_GetMapSky2ScrollDelta(map);
	Sky1ColumnOffset = 0;
	Sky2ColumnOffset = 0;*/
//	DoubleSky = 0;//P_GetMapDoubleSky(map);
}
...
#ifdef RANGECHECK
	//--- MSVS stuff.
	// Added (unsigned) before viewheight.
	//--- jk
