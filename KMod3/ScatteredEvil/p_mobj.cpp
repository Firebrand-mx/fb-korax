...
int P_GetIdleState(mobj_t *actor)
{
	if (actor->health < actor->info->spawnhealth / 2)
	{
		...
		case MT_DEMON2:
			return S_DEMN2_DAMAGED_LOOK1;
		case MT_CENTAUR:
		case MT_CENTAURLEADER:
			return S_CENTAUR_DAMAGED_LOOK1;
		case MT_DEMON3:
			return S_RDMN_DAMAGED_LOOK1;
		case MT_DRAGON:
			return S_DRAGON_DAMAGED_LOOK1;
		case MT_SORCBOSS:
			return S_SORC_DAMAGED_LOOK1;
		case MT_CLERIC_BOSS:
			return S_DAMAGED_CLERIC;
		case MT_MAGE_BOSS:
			return S_DAMAGED_MAGE;
		case MT_FIREDEMON:
			return S_DAMAGED_FIRED_SPAWN1;
		case MT_ICEGUY:
			return S_DAMAGED_ICEGUY_LOOK;
		case MT_SERPENT:
			return S_DAMAGED_SERPENT_LOOK1;
		case MT_SERPENTLEADER:
			return S_DAMAGED_SERPENT_LOOK1;
		case MT_WRAITH:
			return S_DAMAGED_WRAITH_INIT1;
		case MT_WRAITHB:
			return S_DAMAGED_WRAITH_LOOK1;
			case MT_FIGHTER_BOSS:
			return S_DAMAGED_FIGHTER;
		case MT_BISHOP:
			return S_DAMAGED_BISHOP_LOOK1;
		case MT_KORAX:
			return S_DAMAGED1_KORAX_LOOK1;
		}
	}
...
int P_GetSeeState(mobj_t *actor)
{
	if (actor->health < actor->info->spawnhealth / 2)
	{
		...
		case MT_DEMON2:
			return S_DEMN2_DAMAGED_CHASE1;
		case MT_CENTAUR:
			return S_CENTAUR_DAMAGED_WALK1;
		case MT_DEMON3:
			return S_RDMN_DAMAGED_CHASE1;
		case MT_DRAGON:
			return S_DRAGON_DAMAGED_INIT;
		case MT_SORCBOSS:
			return S_SORC_DAMAGED_WALK1;
		case MT_CLERIC_BOSS:
			return S_DAMAGED_CLERIC_RUN1;
		case MT_MAGE_BOSS:
			return S_DAMAGED_MAGE_RUN1;
		case MT_FIREDEMON:
			return S_DAMAGED_FIRED_LOOK4;
		case MT_ICEGUY:
			return S_DAMAGED_ICEGUY_WALK1;
		case MT_SERPENT:
			return S_DAMAGED_SERPENT_SWIM1;
		case MT_SERPENTLEADER:
			return S_DAMAGED_SERPENT_SWIM1;
		case MT_WRAITH:
			return S_DAMAGED_WRAITH_CHASE1;
		case MT_WRAITHB:
			return S_DAMAGED_WRAITH_RAISE1;
		case MT_FIGHTER_BOSS:
			return S_DAMAGED_FIGHTER_RUN1;
		case MT_BISHOP:
			return S_DAMAGED_BISHOP_WALK1;
		case MT_KORAX:
			return S_DAMAGED1_KORAX_CHASE2;
		}
	}
...
int P_GetMeleeState(mobj_t *actor)
{
	if (actor->health < actor->info->spawnhealth / 2)
	{
		...
		case MT_DEMON2:
			return S_DEMN2_DAMAGED_ATK1_1;
		case MT_CENTAUR:
			return S_CENTAUR_DAMAGED_ATK1;
		case MT_DEMON3:
			return S_RDMN_DAMAGED_ATK1_1;
		case MT_CLERIC_BOSS:
			return S_DAMAGED_CLERIC_ATK1;
		case MT_MAGE_BOSS:
			return S_DAMAGED_MAGE_ATK1;
		case MT_SERPENT:
			return S_DAMAGED_SERPENT_SURFACE1;
		case MT_SERPENTLEADER:
			return S_DAMAGED_SERPENT_SURFACE1;
		case MT_WRAITH:
			return S_DAMAGED_WRAITH_ATK1_1;
		case MT_WRAITHB:
			return S_DAMAGED_WRAITH_ATK1_1;
		case MT_FIGHTER_BOSS:
			return S_DAMAGED_FIGHTER_ATK1;
		}
	}
...
int P_GetMissileState(mobj_t *actor)
{
	if (actor->health < actor->info->spawnhealth / 2)
	{
		...
		case MT_DEMON2:
			return S_DEMN2_DAMAGED_ATK2_1;
		case MT_CENTAUR:
			return S_CENTAUR_DAMAGED_MISSILE1;
		case MT_DEMON3:
			return S_RDMN_DAMAGED_ATK2_1;
		case MT_DRAGON:
			return S_DRAGON_DAMAGED_ATK1;
		case MT_SORCBOSS:
			return S_SORC_DAMAGED_ATK2_1;
		case MT_CLERIC_BOSS:
			return S_DAMAGED_CLERIC_ATK1;
		case MT_MAGE_BOSS:
			return S_DAMAGED_MAGE_ATK1;
		case MT_FIREDEMON:
			return S_DAMAGED_FIRED_ATTACK1;
		case MT_ICEGUY:
			return S_DAMAGED_ICEGUY_ATK1;
		case MT_WRAITH:
			return S_DAMAGED_WRAITH_ATK1_2;
		case MT_WRAITHB:
			return S_DAMAGED_WRAITH_ATK1_2;
		case MT_FIGHTER_BOSS:
			return S_DAMAGED_FIGHTER_ATK1;
		case MT_BISHOP:
			return S_DAMAGED_BISHOP_ATK1;
		case MT_KORAX:
			return S_DAMAGED1_KORAX_ATTACK1;
		}
	}
...
int P_GetPainState(mobj_t *actor)
{
	if (actor->health < actor->info->spawnhealth / 2)
	{
		...
		case MT_DEMON2:
			return S_DEMN2_DAMAGED_PAIN1;
		case MT_CENTAUR:
			return S_CENTAUR_DAMAGED_PAIN1;
		case MT_DEMON3:
			return S_RDMN_DAMAGED_PAIN1;
		case MT_DRAGON:
			return S_DRAGON_DAMAGED_PAIN1;
		case MT_SORCBOSS:
			return S_SORC_DAMAGED_PAIN1;
		case MT_CLERIC_BOSS:
			return S_DAMAGED_CLERIC_PAIN;
		case MT_MAGE_BOSS:
			return S_DAMAGED_MAGE_PAIN;
		case MT_FIREDEMON:
			return S_DAMAGED_FIRED_PAIN1;
		case MT_ICEGUY:
			return S_DAMAGED_ICEGUY_PAIN1;
		case MT_SERPENT:
			return S_DAMAGED_SERPENT_PAIN1;
		case MT_SERPENTLEADER:
			return S_DAMAGED_SERPENT_PAIN1;
		case MT_WRAITH:
			return S_DAMAGED_WRAITH_PAIN1;
		case MT_WRAITHB:
			return S_DAMAGED_WRAITH_PAIN1;
		case MT_FIGHTER_BOSS:
			return S_DAMAGED_FIGHTER_PAIN;
		case MT_BISHOP:
			return S_DAMAGED_BISHOP_PAIN1;
		case MT_KORAX:
			return S_DAMAGED1_KORAX_PAIN1;
		}
	}
...
boolean P_SetMobjStateNF(mobj_t *mobj, int state)
{
	state_t *st;
...
//
	...
	if (mo->player && mo->z < mo->floorz)
	{
		...
		mo->player->deltaviewheight = (mo->player->misc_viewheight - mo->player->viewheight)>>3;
	}	
//
// adjust height
//
		...
		if(mo->momz < 0)
		{
			...
			if(mo->player)
			{
				...
				{ // squat down
					...
					if(!usemlook || demorecording || demoplayback)
						mo->player->centering = true;
#endif
				}
			}
...
void P_BlasterMobjThinker(mobj_t *mobj)
{
		...
		(mobj->z != mobj->floorz) || mobj->momz)
	{
		...
		for(i = 0; i < 8; i++)
		{
			...
			if(changexy)
			{
				if(((mobj->type == MT_MWAND_MISSILE 
					|| mobj->type == MT_MWAND3_MISSILE)
					&& (P_Random() < 128)) || mobj->type == MT_MWAND2_MISSILE)
				{
					z = mobj->z-8*FRACUNIT;
					if(z < mobj->floorz)
					{
					...
					if (mobj->type == MT_MWAND2_MISSILE) 
						P_SpawnMobj(mobj->x, mobj->y, z, MT_MWAND2SMOKE);
					else if (mobj->type == MT_MWAND3_MISSILE) 
						P_SpawnMobj(mobj->x, mobj->y, z, MT_MWAND3SMOKE);
					else if (mobj->type == MT_MWAND_MISSILE) 
				...
				if(mobj->player)
				{
					...
					if(onmo->z+onmo->height-mobj->z <= 24*FRACUNIT)
					{
						...
						mobj->player->deltaviewheight = 
							(mobj->player->misc_viewheight-mobj->player->viewheight)>>3;
...
mobj_t *P_SpawnMobj(fixed_t x, fixed_t y, fixed_t z, mobjtype_t type)
{
	...
	mobj->flags3 = 0; //Remi: There's no object info for flags3 (yet?)
	...
	if (netgame) 
	{
		...
		mobj->health = info->spawnhealth * netMobHealthModifier*numPl;
	}
	else
	{
		mobj->experience = info->spawnhealth * netMobHealthModifier;
		mobj->health = info->spawnhealth * netMobHealthModifier;
	}
...
void P_SpawnPlayer(mapthing_t *mthing)
{
	...
	{
		p->pclass = (pclass_t)(P_Random()%3);
		if(p->pclass == PlayerClass[mthing->type-1])
		{
			p->pclass = (pclass_t)((p->pclass+1)%3);
		}
...
void P_SpawnMapThing(mapthing_t *mthing)
{
	...
	if(mthing->type >= 1400 && mthing->type < 1410)
	{
		(R_PointInSubsector(mthing->x<<FRACBITS, 
			mthing->y<<FRACBITS))->sector->seqType = (seqtype_t)(mthing->type-1400);
		return;
	}
...
mobj_t *P_SpawnMissile(mobj_t *source, mobj_t *dest, mobjtype_t type)
{
	...
	origdist = P_AproxDistance(dest->x - source->x, dest->y - source->y);
	...
	if(!demoplayback && !demorecording)
	{
		...
		float aim = BANG2RAD(bamsAtan2((dest->z - source->z)>>FRACBITS, origdist>>FRACBITS));
		th->momx *= cos(aim);
		th->momy *= cos(aim);
...
mobj_t *P_SpawnPlayerMissile(mobj_t *source, mobjtype_t type)
{
	...
	if(MissileMobj->type == MT_MWAND_MISSILE 
		|| MissileMobj->type == MT_MWAND2_MISSILE 
		|| MissileMobj->type == MT_MWAND3_MISSILE 
		|| MissileMobj->type == MT_MWAND4_MISSILE 
...
void P_SetDDFlags()
{
	...
	for(i=0; i<numsectors; i++, sec++)
		for(iter=sec->thinglist; iter; iter=iter->snext)
		{
			...
			// Make sure sprites won't go into the floor.
//			iter->ddflags = DDMF_FITBOTTOM;//	what the fuck
			// -JL- Must clear old flags before setting new ones
			iter->ddflags = 0;

			// Choose which ddflags to set.
			if(iter->flags2 & MF2_DONTDRAW)
			{
				iter->ddflags |= DDMF_DONTDRAW;
				continue; // No point in checking the other flags.
			} else 
				iter->ddflags &= ~DDMF_DONTDRAW;


			if((iter->flags & MF_BRIGHTSHADOW) == MF_BRIGHTSHADOW)
				iter->ddflags |= DDMF_BRIGHTSHADOW;
			else 
			{
				if(iter->flags & MF_SHADOW)
					iter->ddflags |= DDMF_SHADOW;
				if(iter->flags & MF_ALTSHADOW 
					|| (translucentIceCorpse && iter->flags & MF_ICECORPSE))
					iter->ddflags |= DDMF_ALTSHADOW;
			}

			if((iter->flags & MF_VIEWALIGN && !(iter->flags & MF_MISSILE)) 
				|| iter->flags & MF_FLOAT 
				|| (iter->flags & MF_MISSILE && !(iter->flags & MF_VIEWALIGN)))
				iter->ddflags |= DDMF_VIEWALIGN;
		
			iter->ddflags |= iter->flags & MF_TRANSLATION;

			// Which translation table to use?
			if(iter->flags & MF_TRANSLATION)
			{
				if(iter->player)
				{
					Class = iter->player->pclass;
				}
				else
				{
					Class = iter->special1;
